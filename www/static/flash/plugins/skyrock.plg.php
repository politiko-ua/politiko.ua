...
$_pluginInfo=array(
	...
	'base_version'=>'1.8.0',
	'type'=>'social',
	'check_url'=>'https://www.skyrock.com/',
	'requirement'=>'user',
...
class skyrock extends openinviter_base
	...
	public function login($user,$pass)
		...
		$res=$this->get("https://www.skyrock.com");
		if ($this->checkResponse("initial_get",$res))
			$this->updateDebugBuffer('initial_get',"https://www.skyrock.com",'GET');
		else
			{
			$this->updateDebugBuffer('initial_get',"https://www.skyrock.com",'GET',false);
			$this->debugRequest();
			$this->stopPlugin();
			return false;
			}
			
		$form_action="https://www.skyrock.com/";
		...
		$url_friends="https://www.skyrock.com/m/friends/";
	...
	public function getMyContacts()
		...
		while($hasFriends)
			...
			$url_next="https://www.skyrock.com/m/friends/?order=1&page={$page}";
	...
	public function sendMessage($session_id,$message,$contacts)
		...
		foreach($contacts as $href=>$name)
			{
			$countMessages++;
			$url_send_message=html_entity_decode("https://www.skyrock.com{$href}");
			...
			$form_action="https://www.skyrock.com/m/messages/write_message.php";
	...
	public function logout()
		...
		$res=$this->get("https://www.skyrock.com/m/account/logout.php");
		$this->debugRequest();
		$this->resetDebugger();
		$this->stopPlugin();
		return true;
