...
$_pluginInfo=array(
	...
	'base_version'=>'1.8.0',
	'type'=>'social',
	'check_url'=>'https://www.myspace.com',
	'requirement'=>'email',
...
class myspace extends openinviter_base
	...
	public function login($user,$pass)
		...
		$res=$this->get("https://www.myspace.com/");
		if ($this->checkResponse("initial_get",$res))
			$this->updateDebugBuffer('initial_get',"https://www.myspace.com/",'GET');
		else
			{
			$this->updateDebugBuffer('initial_get',"https://www.myspace.com/",'GET',false);
			$this->debugRequest();
			$this->stopPlugin();
			return false;
			}
		$form_action="https://secure.myspace.com/index.cfm?fuseaction=login.process";
		...
		$url_friends="https://friends.myspace.com/index.cfm?fuseaction=user.viewfriends&friendID=".$this->getElementString($res,'"UserId":',',');
	...
	public function getMyContacts()
		...
		$doc=new DOMDocument();libxml_use_internal_errors(true);if (!empty($res)) $doc->loadHTML($res);libxml_use_internal_errors(false);
			...
			foreach ($data as $node)
				$contacts[str_replace('https://www.myspace.com/','',$node->getAttribute('href'))]=(string)$node->nodeValue;
	...
	public function sendMessage($session_id,$message,$contacts)
		{
		$res=$this->get("https://friends.myspace.com/index.cfm?fuseaction=user.viewfriends&friendID=",true);
		$mytokenvar=$this->getElementString($res,"MyToken=","')");
		$countMessages=0;
		foreach($contacts as $id=>$name)
			{
			$countMessages++;
			$url_messaging="https://messaging.myspace.com/index.cfm?fuseaction=mail.message&friendID={$id}&MyToken={$mytokenvar}";
	...
	public function logout()
		...
		$res=$this->get("https://www.myspace.com/index.cfm?fuseaction=signout",true);
		$this->debugRequest();
		$this->resetDebugger();
		$this->stopPlugin();
		return true;	
