...
$_pluginInfo=array(
	...
	'base_version'=>'1.8.0',
	'type'=>'email',
	'check_url'=>'https://m.linkedin.com/session/new',
	'requirement'=>'email',
...
class linkedin extends openinviter_base
	...
	public function login($user,$pass)
		...
		$res=$this->get("https://m.linkedin.com/session/new");
		if ($this->checkResponse("initial_get",$res))
			$this->updateDebugBuffer('initial_get',"https://m.linkedin.com/session/new",'GET');
		else
			{
			$this->updateDebugBuffer('initial_get',"https://m.linkedin.com/session/new",'GET',false);
			$this->debugRequest();
			$this->stopPlugin();
			return false;
			}
	...
	public function logout()
		...
		$res=$this->get("https://m.linkedin.com/session/logout",true);
		$this->debugRequest();
		$this->resetDebugger();
		$this->stopPlugin();
		return true;	
