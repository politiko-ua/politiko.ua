...
$_pluginInfo=array(
	...
	'base_version'=>'1.8.4',
	'type'=>'social',
	'check_url'=>'https://www.friendster.com',
	'requirement'=>'email',
...
class friendster extends openinviter_base
	...
	public function login($user,$pass)
		...
		$res=$this->get("https://www.friendster.com/");	
		if ($this->checkResponse("initial_get",$res))
			$this->updateDebugBuffer('initial_get',"https://www.friendster.com/",'GET');
		else
			{
			$this->updateDebugBuffer('initial_get',"https://www.friendster.com/",'GET',false);
			$this->debugRequest();
			$this->stopPlugin();
			return false;
			}
		
		$form_action="https://www.friendster.com/login.php";
		...
		$url_friends="https://www.friendster.com/friends.php";	
	...
	public function getMyContacts()
		...
		do
			...
			foreach ($data as $node)
				$contacts[str_replace("https://profiles.friendster.com/","",(string)$node->firstChild->getAttribute('href'))]=(string)$node->firstChild->nodeValue;
	...
	public function sendMessage($session_id,$message,$contacts)
		...
		foreach ($contacts as $id=>$name)
			{
			$countMessages++;
			$res=$this->get("https://www.friendster.com/sendmessage.php?uid={$id}",true);
			if ($this->checkResponse('message_compose',$res))
				$this->updateDebugBuffer('message_compose',"https://www.friendster.com/sendmessage.php?uid={$id}",'GET');
			else
				{
				$this->updateDebugBuffer('message_compose',"https://www.friendster.com/sendmessage.php?uid={$id}",'GET',false);
				$this->debugRequest();
				$this->stopPlugin();
				return false;
				}
				
			$form_action="https://www.friendster.com/sendmessage.php";
	...
	public function logout()
		...
		$res=$this->get("https://www.friendster.com/logout.php",true);
		$this->debugRequest();
		$this->resetDebugger();
		$this->stopPlugin();
		return true;	
