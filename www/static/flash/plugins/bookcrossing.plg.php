...
$_pluginInfo=array(
	...
	'base_version'=>'1.8.0',
	'type'=>'social',
	'check_url'=>'https://www.bookcrossing.com/',
	'requirement'=>'email',
...
class bookcrossing extends openinviter_base
	...
	public function login($user,$pass)
		...
		$res=$this->get('https://bookcrossing.com/login',true);
		if ($this->checkResponse("initial_get",$res))
			$this->updateDebugBuffer('initial_get',"https://bookcrossing.com/login",'GET');
		else
			{
			$this->updateDebugBuffer('initial_get',"https://bookcrossing.com/login",'GET',false);
			$this->debugRequest();
			$this->stopPlugin();
			return false;
			}
			
		$form_action='https://bookcrossing.com/login';
		$post_elements=array('action'=>'submitLoginForm','currentaction'=>'login','email'=>$user,'password'=>$pass);
		$res=$this->post("https://bookcrossing.com/action.htm",$post_elements,true,true);
		...
		$this->login_ok="https://bookcrossing.com/friends";
		return true;
		}
	...
	public function sendMessage($session_id,$message,$contacts)
		...
		foreach($contacts as $name)
			{
			$countMessages++;
			$form_action="https://bookcrossing.com/sendmessage/{$name}";
	...
	public function logout()
		...
		$res=$this->get("https://bookcrossing.com/logout");
		$this->debugRequest();
		$this->resetDebugger();
		$this->stopPlugin();
		return true;	
