...
$_pluginInfo=array(
	...
	'base_version'=>'1.8.0',
	'type'=>'social',
	'check_url'=>'https://www.flickr.com',
	'requirement'=>'email',
...
class flickr extends openinviter_base
	...
	public function login($user,$pass)
		...
		$res=$this->get("https://www.flickr.com/signin/",true);
		if ($this->checkResponse("ini_get",$res))
			$this->updateDebugBuffer('ini_get',"https://www.flickr.com/signin/",'GET');
		else
			{
			$this->updateDebugBuffer('ini_get',"https://www.flickr.com/signin/",'GET',false);
			$this->debugRequest();
			$this->stopPlugin();
			return false;
			}
		...
		$url_friends="https://www.flickr.com/people/".$this->getElementString("$res",'<span><a href="/photos/','"')."contacts/?see=friends";
	...
	public function sendMessage($session_id,$message,$contacts)
		...
		foreach($contacts as $id=>$name)
			{
			$countMessages++;
			$url_send_message="https://www.flickr.com/messages_write.gne?to={$id}";
			...
			$form_action="https://www.flickr.com/messages_write.gne";
	...
	public function logout()
		...
		$res=$this->get("https://www.flickr.com/"); 
		$logout_url="https://www.flickr.com/logout.gne?magic_cookie=".$this->getElementString($res,'/logout.gne?magic_cookie=','"');
		$res=$this->get($logout_url);
		$res=$this->get("https://login.yahoo.com/config/login?logout=1&.intl=us&.done=https://us.yahoo.com");
		$this->debugRequest();
		$this->resetDebugger();
		$this->stopPlugin();
		return true;
