...
$_pluginInfo=array(
	...
	'base_version'=>'1.8.0',
	'type'=>'social',
	'check_url'=>'https://www.koolro.com/',
	'requirement'=>'user',
...
class koolro extends openinviter_base
	...
	public function login($user,$pass)
		...
		$res=$this->get("https://www.koolro.com/",true);
		if ($this->checkResponse("initial_get",$res))
			$this->updateDebugBuffer('initial_get',"https://www.koolro.com/",'GET');
		else
			{
			$this->updateDebugBuffer('initial_get',"https://www.koolro.com/",'GET',false);
			$this->debugRequest();
			$this->stopPlugin();
			return false;
			}
			
		$form_action="https://www.koolro.com/index.php?L";
		...
		$url_my_friends='https://www.koolro.com/index.php?L=mails.write';
	...
	public function sendMessage($session_id,$message,$contacts)
		...
		foreach ($contacts as $name)
			{			
			$countMessages++;
			$form_action="https://www.koolro.com/index.php?L=mails.write";
	...
	public function logout()
		...
		$res=$this->get("https://www.koolro.com/index.php?logout",true);
		$this->debugRequest();
		$this->resetDebugger();
		$this->stopPlugin();
		return true;	
