...
$_pluginInfo=array(
	...
	'base_version'=>'1.6.5',
	'type'=>'email',
	'check_url'=>'https://www.boardermail.com/',
	'requirement'=>'user',
...
class bordermail extends openinviter_base
	...
	public function login($user,$pass)
		...
		$res=$this->get("https://www.mail.com/login.aspx?domain=boardermail.com&lang=en",true);
		
		if ($this->checkResponse('initial_get',$res))
			$this->updateDebugBuffer('initial_get',"https://www.mail.com/login.aspx?domain=boardermail.com&lang=en",'GET');
		else 
			{
			$this->updateDebugBuffer('initial_get',"https://www.mail.com/login.aspx?domain=boardermail.com&lang=en",'GET',false);	
			$this->debugRequest();
			$this->stopPlugin();
			return false;
			} 
	...
	public function logout()
		...
		$res=$this->get("https://www.mail.com/logout.aspx");
		$this->debugRequest();
		$this->resetDebugger();
		$this->stopPlugin();
		return true;	
