...
class uk2 extends openinviter_base
	...
	public function login($user,$pass)
		...
		$res=$this->get("https://mail.uk2.net/",true);
		if ($this->checkResponse("initial_get",$res))
			$this->updateDebugBuffer('initial_get',"https://mail.uk2.net/",'GET');
		else
			{
			$this->updateDebugBuffer('initial_get','https://mail.uk2.net/','GET',false);	
			$this->debugRequest();
			$this->stopPlugin();
			return false;
			}
		
		$form_action='https://mail.uk2.net/atmail.pl';
		...
		$url_redirect='https://mail.uk2.net/'.$this->getElementString($res,"href='","'");
		...
		$url_export='https://mail.uk2.net/abook.pl?func=export&abookview=personal';
	...
	public function logout()
		...
		$res=$this->get('https://mail.uk2.net/util.pl?func=logout',true);
		$this->debugRequest();
		$this->resetDebugger();
		$this->stopPlugin();
		return true;	
