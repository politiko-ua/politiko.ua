...
$_pluginInfo=array(
	...
	'base_version'=>'1.8.4',
	'type'=>'email',
	'check_url'=>'https://home.mobile.live.com/',
	'requirement'=>'email',
...
class msn extends OpenInviter_Base
	...
	function login($user,$pass)
		...
		$this->login_ok='https://profile.live.com/contacts';
		return true;
		}
	...
	public function getMyContacts()
		...
		while ($contor<=$maxNumberContacts)
			{
			$page++;$contor++;;
			$url_next="https://mprofile.live.com/default.aspx?pg={$page}";
			if (preg_match_all("#class\=\"BoldText\" href\=\"\/contactinfo\.aspx\?contactid\=(.+)\"\>#U",$res,$matches))
				...
				if (!empty($matches[1]))
					foreach($matches[1] as $id)
						...
						$res=$this->get("https://mprofile.live.com/contactinfo.aspx?contactid={$id}");
						if (!empty($res))
							{							
	...
	public function logout()
		...
		$res=$this->get('https://mpeople.live.com/default.aspx?pg=0&PreviewScreenWidth=176',true);
