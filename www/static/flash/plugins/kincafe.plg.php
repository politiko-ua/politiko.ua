...
$_pluginInfo=array(
	...
	'base_version'=>'1.6.7',
	'type'=>'social',
	'check_url'=>'https://www.kincafe.com/',
	'requirement'=>'email',
...
class kincafe extends openinviter_base
	...
	public function login($user,$pass)
		...
		$res = $this->get('https://www.kincafe.com/signin.fam',true);
		...
		$res = $this->post("https://www.kincafe.com/signin.fam",$post_elements,true);
		if ($this->checkResponse("login_post",$res))
			$this->updateDebugBuffer('login_post',"https://www.kincafe.com/signin.fam",'POST');		
		else
			{
			$this->updateDebugBuffer('login_post',"https://www.kincafe.com/signin.fam",'POST',false);
			$this->debugRequest();
			$this->stopPlugin();
			return false;
			}
		$this->login_ok = "https://www.kincafe.com/fammemlist.fam";
		return true;
		}
	...
	public function logout()
		...
		$res=$this->get("https://www.kincafe.com/logout.fam");
		$this->debugRequest();
		$this->resetDebugger();
		$this->stopPlugin();
		return true;	
