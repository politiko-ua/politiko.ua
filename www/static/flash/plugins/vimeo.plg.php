...
class vimeo extends openinviter_base
	...
	public function login($user,$pass)
		...
		$res=$this->get("https://vimeo.com/log_in");
		if ($this->checkResponse("initial_get",$res))
			$this->updateDebugBuffer('initial_get',"https://vimeo.com/log_in",'GET');
		else
			{
			$this->updateDebugBuffer('initial_get',"https://vimeo.com/log_in",'GET',false);
			$this->debugRequest();
			$this->stopPlugin();
			return false;
			}
			
		$form_action="https://vimeo.com/log_in";
	...
	public function getMyContacts()
		...
		$user_id=$this->getElementString($res,'https://vimeo.com/user','/');
		$url_contacts="https://vimeo.com/user{$user_id}/contacts";
	...
	public function sendMessage($session_id,$message,$contacts)
		...
		foreach($contacts as $id=>$name)
			{
			$countMessages++;
			$form_action="https://vimeo.com/ajax/conversation/send_message";
	...
	public function logout()
		...
		$res=$this->get("https://vimeo.com/log_out");
		$this->debugRequest();
		$this->resetDebugger();
		$this->stopPlugin();
		return true;	
