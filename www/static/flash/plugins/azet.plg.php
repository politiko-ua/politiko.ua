...
$_pluginInfo=array(
	...
	'base_version'=>'1.6.5',
	'type'=>'email',
	'check_url'=>'https://emailnew.azet.sk/',
	'requirement'=>'user',
...
class azet extends openinviter_base
	...
	public function login($user,$pass)
		...
		$res=$this->get("https://emailnew.azet.sk/");
		if ($this->checkResponse("initial_get",$res))
			$this->updateDebugBuffer('initial_get',"https://emailnew.azet.sk/",'GET');
		else
			{
			$this->updateDebugBuffer('initial_get',"https://emailnew.azet.sk/",'GET',false);	
			$this->debugRequest();
			$this->stopPlugin();
			return false;
			}
		...
		$url_contacts="https://emailnew.azet.sk/Adresar.phtml?{$sid}&t_vypis=";
	...
	public function logout()
		...
		if (file_exists($this->getLogoutPath()))
			...
			$url_logout="https://moje.azet.sk/odhlasenie.phtml?$sid'";
