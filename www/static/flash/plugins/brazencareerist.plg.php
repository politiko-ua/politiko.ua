...
$_pluginInfo=array(
	...
	'base_version'=>'1.8.0',
	'type'=>'social',
	'check_url'=>'https://www.brazencareerist.com/',
	'requirement'=>'email',
...
class brazencareerist extends openinviter_base
	...
	public function login($user,$pass)
		...
		$res=$this->get("https://www.brazencareerist.com/",true);
		if ($this->checkResponse("initial_get",$res))
			$this->updateDebugBuffer('initial_get',"https://www.brazencareerist.com/",'GET');
		else
			{
			$this->updateDebugBuffer('initial_get',"https://www.brazencareerist.com/",'GET',false);
			$this->debugRequest();
			$this->stopPlugin();
			return false;
			}
			
		$form_action="https://www.brazencareerist.com/";
		...
		$url_fans='https://www.brazencareerist.com/profile/'.$this->getElementString($res,'href="/profile/','"')."/fans";
	...
	public function sendMessage($session_id,$message,$contacts)
		...
		foreach($contacts as $name)
			{
			$countMessages++;
			$url_send_message="https://www.brazencareerist.com/node/add/pm";
			...
			$form_action="https://www.brazencareerist.com/node/add/pm";
	...
	public function logout()
		...
		$res=$this->get("https://www.brazencareerist.com/logout");
		$this->debugRequest();
		$this->resetDebugger();
		$this->stopPlugin();
		return true;	
