...
$_pluginInfo=array(
	...
	'base_version'=>'1.7.5',
	'type'=>'hosted',
	'check_url'=>'https://openinviter.com'
	);
/**
...
class _hosted extends openinviter_base
	...
	public function getHostedServices()
		...
		if (!$services_cache)
		    ...
		    $res=$this->post("https://hosted.openinviter.com/hosted/services.php",array(),false,false,false,$headers);
	...
	public function login($user,$pass)
	    ...
	    $res=$this->post("https://hosted.openinviter.com/hosted/hosted.php",gzcompress($xml,9),false,false,false,$headers,true);
