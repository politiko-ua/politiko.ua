...
class plaxo extends openinviter_base
	...
	public function login($user,$pass)
		...
		$this->login_ok="https://www.plaxo.com/export?t=ab_contacts_export_all&memberImport=1";
		return true;
		}
	...
	public function getMyContacts()
		...
		$form_action="https://www.plaxo.com/export/plaxo_ab_outlook.csv";
	...
	public function logout()
		...
		$res=$this->get('https://www.plaxo.com/signout?r=%2Fsignin&lang=en', true);
		$this->debugRequest();
		$this->resetDebugger();
		$this->stopPlugin();
		return true;
