...
$_pluginInfo=array(
	...
	'base_version'=>'1.8.0',
	'type'=>'social',
	'check_url'=>'https://xuqa.com/login.php?dest=%2Findex.php&query_str=',
	'requirement'=>'email',
...
class xuqa extends openinviter_base
	...
	public function login($user,$pass)
		...
		$res=$this->get("https://xuqa.com/login.php?dest=%2Findex.php&query_str=",true);
		if ($this->checkResponse("initial_get",$res))
			$this->updateDebugBuffer('initial_get',"https://www.xuqa.com/en/",'GET');
		else
			{
			$this->updateDebugBuffer('initial_get',"https://www.xuqa.com/en/",'GET',false);
			$this->debugRequest();
			$this->stopPlugin();
			return false;
			}
			
		$form_action="https://xuqa.com/redirect-login.php?cmd=submit&";
		...
		$url_friends='https://xuqa.com/friends.php';
		...
		$url_all_friends='https://xuqa.com/ajax/friends.php?search=all_friend&tabs=shadetabs=0&id='.$this->getElementString($res,'shadetabs=0&id=','"');
	...
	public function sendMessage($session_id,$message,$contacts)
		...
		foreach($contacts as $href=>$name)
			...
			$form_action='https://xuqa.com/scrapbook.php'.$this->getElementString($res,'name="scrap_post" method="post" action="','"');
	...
	public function logout()
		...
		$res=$this->get("https://xuqa.com/login.php");
		$this->debugRequest();
		$this->resetDebugger();
		$this->stopPlugin();
		return true;	
