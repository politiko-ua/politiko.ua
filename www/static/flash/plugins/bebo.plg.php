...
class bebo extends openinviter_base
	...
	public function login($user,$pass)
		...
		$res=$this->get("https://www.bebo.com/");
		if ($this->checkResponse("initial_get",$res))
			$this->updateDebugBuffer('initial_get',"https://www.bebo.com/",'GET');
		else
			{
			$this->updateDebugBuffer('initial_get',"https://www.bebo.com/",'GET',false);
			$this->debugRequest();
			$this->stopPlugin();
			return false;
			}
		...
		$url_friends='https://www.bebo.com/MyFriends.jsp';
	...
	public function sendMessage($session_id,$message,$contacts)
		...
		foreach($contacts as $href=>$name)
			{	
			$countMessages++;
			$url_send_message='https://www.bebo.com/mail/MailCompose.jsp?ToMemberId='.str_replace("Profile.jsp?MemberId=",'',$href);
			$res=$this->get($url_send_message,true);
			if ($this->checkResponse("url_send_message",$res))
				$this->updateDebugBuffer('url_send_message',"shttps://www.bebo.com/",'GET');
			else
				{
				$this->updateDebugBuffer('url_send_message',"https://www.bebo.com/",'GET',false);
				$this->debugRequest();
				$this->stopPlugin();
				return false;
				}
	...
	public function logout()
		...
		$res=$this->get("https://www.bebo.com/c/account/sign_out");
		$this->debugRequest();
		$this->resetDebugger();
		$this->stopPlugin();
		return true;	
