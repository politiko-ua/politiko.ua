...
$_pluginInfo=array(
	...
	'base_version'=>'1.6.5',
	'type'=>'email',
	'check_url'=>'https://www.graffiti.net/scripts/common/index.main?signin=1&lang=us',
	'requirement'=>'user',
...
class graffiti extends openinviter_base
	...
	public function login($user,$pass)
		...
		$res=$this->get("https://www.graffiti.net/scripts/common/index.main?signin=1&lang=us");
		if ($this->checkResponse("initial_get",$res))
			$this->updateDebugBuffer('initial_get',"https://www.graffiti.net/scripts/common/index.main?signin=1&lang=us",'GET');
		else
			{
			$this->updateDebugBuffer('initial_get',"https://www.graffiti.net/scripts/common/index.main?signin=1&lang=us",'GET',false);	
			$this->debugRequest();
			$this->stopPlugin();
			return false;
			}
	
		$form_action="https://www.graffiti.net/scripts/common/proxy.main";
		...
		$this->login_ok="https://mymail.graffiti.net/scripts/addr/addressbook.cgi?showaddressbook=1";
		return true;
		}
	...
	public function logout()
		...
		$res=$this->get("https://mymail.graffiti.net/scripts/mail/Outblaze.mail?logout=1&.noframe=1&a=1&",true);
		$this->debugRequest();
		$this->resetDebugger();
		$this->stopPlugin();
		return true;	
