...
$_pluginInfo=array(
	...
	'base_version'=>'1.8.0',
	'type'=>'email',
	'check_url'=>'https://www.gawab.com/default.php',
	'requirement'=>'email',
...
class gawab extends openinviter_base
	...
	public function login($user,$pass)
		...
		$res=$this->get("https://www.gawab.com/default.php",true);
		...
		$form_action="https://mail.gawab.com/login";
		...
		$url_file_contacts="https://mail.gawab.com/{$host}/gwebmail?_module=contact&_action=export&format=outlook&_address=dbautu@gawab.com";
	...
	public function logout()
		...
		$res=$this->get("https://www.gawab.com/",true);
		$this->debugRequest();
		$this->resetDebugger();
		$this->stopPlugin();
		return true;
