...
class yandex extends openinviter_base
{
	...
	public function login($user, $pass)
		...
		$form_action="https://passport.yandex.ru/passport?mode=auth&retpath=https://mail.yandex.ru";
		...
		$linkToAddressBook="https://mail.yandex.ru/neo/ajax/action_abook_export";
	...
	public function logout()
		...
		$res=$this->get(urldecode("https://passport.yandex.ru/passport?mode=logout"));
		$this->debugRequest();
		$this->resetDebugger();
		$this->stopPlugin();
		}
