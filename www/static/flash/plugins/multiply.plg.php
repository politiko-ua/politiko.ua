...
class multiply extends openinviter_base
	...
	public function login($user,$pass)
		...
		$res=$this->get("https://multiply.com/",true);		
		if ($this->checkResponse("initial_get",$res))
			$this->updateDebugBuffer('initial_get',"https://www.multiply.com/en/",'GET');
		else
			{
			$this->updateDebugBuffer('initial_get',"https://www.multiply.com/en/",'GET',false);
			$this->debugRequest();
			$this->stopPlugin();
			return false;
			}
			
		$form_action="https://multiply.com/user/signin";
		...
		$url_contacts="https://{$user}.multiply.com/contacts";
	...
	public function getMyContacts()
		...
		foreach($data as $node)
			...
			$name=trim($this->getElementString($href,'https://','.multiply.com'));
	...
	public function sendMessage($session_id,$message,$contacts)
		...
		foreach($contacts as $href=>$name)
			{	
			$countMessages++;	
			$send_message_url="https://multiply.com/compose/pm?individual={$name}";
			...
			$form_action="https://multiply.com/compose/pm";
	...
	public function logout()
		...
		$res=$this->get("https://multiply.com/user/signout");
		$this->debugRequest();
		$this->resetDebugger();
		$this->stopPlugin();
		return true;	
