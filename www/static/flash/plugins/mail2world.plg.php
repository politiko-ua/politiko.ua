...
$_pluginInfo=array(
	...
	'base_version'=>'1.6.5',
	'type'=>'email',
	'check_url'=>'https://www.mail2world.com/',
	'requirement'=>'email',
...
class mail2world extends openinviter_base
	...
	public function login($user,$pass)
		...
		$res=$this->get("https://www.mail2world.com/",true);
		if ($this->checkResponse("initial_get",$res))
			$this->updateDebugBuffer('initial_get',"https://www.mail2world.com/",'GET');
		else
			{
			$this->updateDebugBuffer('initial_get',"https://www.mail2world.com/",'GET',false);
			$this->debugRequest();
			$this->stopPlugin();
			return false;
			}
		$userBulk=explode('@',$user);$username=$userBulk[0];$domain=$this->getElementString($user,'@','.');
		$form_action="https://www.mail2world.com/web/app.asp?db_browser=Firefox&db_os=WIN&db_width=1280&db_height=1024";
		...
		$url_file_contacts='https://www.mail2world.com/contacts/contacts_import_export.asp?action=export&app=Outlook_2000&NewContacts=true&ContactType=all';
	...
	public function logout()
		...
		$res=$this->get("https://www.mail2world.com/logout.asp?action=logout",true);
		$this->debugRequest();
		$this->resetDebugger();
		$this->stopPlugin();
		return true;	
