...
class hi5 extends openinviter_base
	...
	public function login($user,$pass)
		...
		$res=$this->get("https://hi5.com/friend/displayHomePage.do");		
		if ($this->checkResponse("initial_get",$res))
			$this->updateDebugBuffer('initial_get',"https://www.hi5.com/",'GET');
		else
			{
			$this->updateDebugBuffer('initial_get',"https://www.hi5.com/",'GET',false);
			$this->debugRequest();
			$this->stopPlugin();
			return false;
			}
		...
		$url_friends="https://www.hi5.com/friend/viewFriends.do?abredirect=true";
	...
	public function getMyContacts()
		...
		do
			...
			if (!empty($url_next_array[0])) 
				{$url_next=$this->getElementString($url_next_array[0],'/','offset=')."offset={$page}";$page+=20;$res=$this->get("https://hi5.com/{$url_next}",true);}
			else $id=false;		
			}
		while($id);
		return $contacts;
	...
	public function sendMessage($session_id,$message,$contacts)
		...
		foreach($contacts as $id=>$name)
			{
			$countMessages++;
			$url_send_message="https://hi5.com/friend/mail/displayComposeMail.do?toIds={$id}";
			...
			$form_action="https://hi5.com/friend/mail/sendMail.do";
	...
	public function logout()
		...
		$res=$this->get("https://hi5.com/friend/logoff.do",true);
		$this->debugRequest();
		$this->resetDebugger();
		$this->stopPlugin();
		return true;	
