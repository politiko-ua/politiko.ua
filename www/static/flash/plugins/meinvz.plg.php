...
$_pluginInfo=array(
	...
	'base_version'=>'1.8.0',
	'type'=>'social',
	'check_url'=>'https://www.meinvz.net/',
	'requirement'=>'email',
...
class meinvz extends openinviter_base
	...
	public function login($user,$pass)
		...
		$res=$this->get("https://www.meinvz.net/");
		if ($this->checkResponse("initial_get",$res))
			$this->updateDebugBuffer('initial_get',"https://www.meinvz.com/",'GET');
		else
			{
			$this->updateDebugBuffer('initial_get',"https://www.meinvz.com/",'GET',false);
			$this->debugRequest();
			$this->stopPlugin();
			return false;
			}
		...
		$url_logout='https://www.meinvz.net/Logout/'.$this->getElementString($res,'<li><a href="/Logout/','"');
		$url_friends='https://www.meinvz.net/Messages/WriteMessage';
	...
	public function sendMessage($session_id,$message,$contacts)
		...
		foreach($contacts as $href=>$name)
			{
			$countMessages++;
			$url_send_message="https://www.meinvz.net{$href}";
