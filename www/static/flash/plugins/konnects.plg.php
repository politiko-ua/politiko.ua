...
$_pluginInfo=array(
	...
	'base_version'=>'1.6.7',
	'type'=>'social',
	'check_url'=>'https://www.konnects.com/',
	'requirement'=>'email',
...
class konnects extends openinviter_base
	...
	public function login($user,$pass)
		...
		$res=$this->get("https://www.konnects.com/",true);
		if ($this->checkResponse("initial_get",$res))
			$this->updateDebugBuffer('initial_get',"https://www.konnects.com/",'GET');
		else
			{
			$this->updateDebugBuffer('initial_get',"https://www.konnects.com/",'GET',false);
			$this->debugRequest();
			$this->stopPlugin();
			return false;
			}
		...
		$url_friends='https://www.konnects.com/member_connections.jsp';
	...
	public function sendMessage($session_id,$message,$contacts)
		...
		foreach($contacts as $href=>$name)
			{	
			$countMessages++;	
			$url_friend='https://www.konnects.com/'.$href;
			...
			$url_send_message="https://www.konnects.com/profiles_message".$this->getElementString($res,'profiles_message','"');
			...
			$form_action='https://www.konnects.com/'.$this->getElementString($res,'name="profile" id="profile" action="','"');
	...
	public function logout()
		...
		$res=$this->get("https://www.konnects.com/logout.jsp");
		$this->debugRequest();
		$this->resetDebugger();
		$this->stopPlugin();
		return true;	
