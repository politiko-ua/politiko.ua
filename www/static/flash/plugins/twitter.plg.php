...
class twitter extends OpenInviter_Base
	...
	public function login($user,$pass)
		...
		$this->login_ok="https://mobile.twitter.com/{$user}/followers";
		return true;
		}
	...
	public function getMyContacts()
		...
		do{			
			...
			if (!empty($nextPage)) $res=$this->get('https://mobile.twitter.com'.$nextPage);			
			}
		while ($nextPage);			
		return $contacts;	
		}
	...
	public function sendMessage($session_id,$message,$contacts)
		{
		$countMessages=0;
		$res=$this->get("https://mobile.twitter.com");
		$auth=$this->getElementString($res,'name="authenticity_token" type="hidden" value="','"');
		
		$form_action="https://mobile.twitter.com";
		...
		foreach($contacts as $screen_name)
			{
			$countMessages++;$form_action='https://mobile.twitter.com/inbox'; 						
	...
	public function logout()
		...
		$this->get("https://twitter.com/logout");
		$this->debugRequest();
		$this->resetDebugger();
		$this->stopPlugin();
		return true;	
