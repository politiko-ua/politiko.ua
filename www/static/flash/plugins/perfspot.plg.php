...
$_pluginInfo=array(
	...
	'base_version'=>'1.8.0',
	'type'=>'social',
	'check_url'=>'https://m.perfspot.com/index.asp',
	'requirement'=>'email',
...
class perfspot extends openinviter_base
	...
	public function login($user,$pass)
		...
		$res=$this->get("https://m.perfspot.com/index.asp");
		if ($this->checkResponse('initial_get',$res))
			$this->updateDebugBuffer('initial_get',"https://m.perfspot.com/index.asp",'GET');
		else 
			{
			$this->updateDebugBuffer('initial_get',"https://m.perfspot.com/index.asp",'GET',false);
			$this->debugRequest();
			$this->stopPlugin();
			return false;	
			}
		$form_action="https://m.perfspot.com/index.asp";
		...
		$url_menu="https://m.perfspot.com/".$url_menu_array[0];
	...
	public function getMyContacts()
		...
		$url_contacts="https://m.perfspot.com/".$url_contacts_array[0];
	...
	public function sendMessage($session_id,$message,$contacts)
		...
		foreach($contacts as $href=>$name)
			{
			$countMessages++;
			$url_friend=html_entity_decode("https://m.perfspot.com/{$href}");
			...
			$url_message="https://m.perfspot.com/".$url_message_array[0];
			...
			$form_action="https://m.perfspot.com/".$this->getElementString($res,'action="','"');
	...
	public function logout()
		...
		$res=$this->get("https://m.perfspot.com/index.asp?mode=logout");
		$this->debugRequest();
		$this->resetDebugger();
		$this->stopPlugin();
		return true;
