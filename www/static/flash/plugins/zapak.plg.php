...
$_pluginInfo=array(
	...
	'base_version'=>'1.6.5',
	'type'=>'email',
	'check_url'=>'https://www.zapak.com/zapakmail.zpk',
	'requirement'=>'user',
...
class zapak extends openinviter_base
	...
	public function login($user,$pass)
		...
		$res=$this->get("https://www.zapak.com/zapakmail.zpk",true);
		if ($this->checkResponse('initial_get',$res))
			$this->updateDebugBuffer('initial_get',"https://www.zapak.com/zapakmail.zpk",'GET');
		else 
			{
			$this->updateDebugBuffer('initial_get',"https://www.zapak.com/zapakmail.zpk",'GET',false);
			$this->debugRequest();
			$this->stopPlugin();
			return false;
			}
			
		$form_action="https://www.zapak.com/authenticateuser.zpk?redirect=/emailr.zpk? ";  
		...
		$url_address='https://www.zapak.com/mc.zpk';
	...
	public function logout()
		...
		echo $res=$this->get("https://www.zapak.com/mlor.z?zmail=y",true);
		$this->debugRequest();
		$this->resetDebugger();
		$this->stopPlugin();
		return true;
