...
$_pluginInfo=array(
	...
	'base_version'=>'1.8.0',
	'type'=>'email',
	'check_url'=>'https://m.libero.it/mail',
	'requirement'=>'email',
...
class libero extends openinviter_base
	...
	public function login($user, $pass)
	{
		...
		$res=$this->get("https://m.libero.it/mail",true);
		if ($this->checkResponse('initial_get',$res))
			$this->updateDebugBuffer('initial_get',"https://m.libero.it/mail",'GET');
		else 
			{
			$this->updateDebugBuffer('initial_get',"https://m.libero.it/mail",'GET',false);
			$this->debugRequest();
			$this->stopPlugin();
			return false;	
			}		
		...
		$post_elements=array("SERVICE_ID"=>"m_mail",
							 "RET_URL"=>"https://m.mailbeta.libero.it/m/wmm/auth/check",
							 "LAYOUT"=>"m",
							 "LOGINID"=>$user,
							 "PASSWORD"=>$pass,
							 "REMEMBERME"=>"S",
		...
		$this->login_ok="https://m.mailbeta.libero.it/m/wmm/contacts";		
		return true;
	}
	...
	public function logout()
		...
		$res=$this->get("https://m.mailbeta.libero.it/doLogout",true);		
		$this->debugRequest();
		$this->resetDebugger();
		$this->stopPlugin();	
		}
