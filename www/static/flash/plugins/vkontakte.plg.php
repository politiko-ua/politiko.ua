...
class vkontakte extends openinviter_base
	...
	public function login($user,$pass)
		...
		$res=$this->get("https://vkontakte.ru/");
		if ($this->checkResponse("initial_get",$res))
			$this->updateDebugBuffer('initial_get',"https://vkontakte.ru/",'GET');
		else
			{
			$this->updateDebugBuffer('initial_get',"https://vkontakte.ru/",'GET',false);
			$this->debugRequest();
			$this->stopPlugin();
			return false;
			}
			
		$form_action="https://vkontakte.ru/login.php";
		...
		$url_friends="https://vkontakte.ru/".$this->getElementString($res,"myfriends'><a href='","'");		
	...
	public function sendMessage($session_id,$message,$contacts)
		...
		foreach($contacts as $id=>$name)
			{
			$countMessages++;
			$url_send_message="https://vkontakte.ru/mail.php?act=write&to={$id}";
			...
			$form_action="https://vkontakte.ru/mail.php";
	...
	public function logout()
		...
		$res=$this->get("https://vkontakte.ru/login.php?op=logout");
		$this->debugRequest();
		$this->resetDebugger();
		$this->stopPlugin();
		return true;	
