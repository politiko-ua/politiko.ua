...
class faces extends openinviter_base
	...
	public function login($user,$pass)
		...
		$res=$this->get("https://www.faces.com/",true);
		if ($this->checkResponse("initial_get",$res))
			$this->updateDebugBuffer('initial_get',"https://www.faces.com/",'GET');
		else
			{
			$this->updateDebugBuffer('initial_get',"https://www.faces.com/",'GET',false);
			$this->debugRequest();
			$this->stopPlugin();
			return false;
			}
			
		$form_action="https://www.faces.com/login";
		...
		$url_friends='https://www.faces.com/friends';
	...
	public function sendMessage($session_id,$message,$contacts)
		{		
		$form_action="https://www.faces.com/mailbox/compose";
	...
	public function logout()
		...
		$res=$this->get("https://www.faces.com/logout");
		$this->debugRequest();
		$this->resetDebugger();
		$this->stopPlugin();
		return true;	
