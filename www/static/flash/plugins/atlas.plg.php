...
class atlas extends openinviter_base
	...
	public function login($user,$pass)
		...
		$res=$this->get("https://auser.centrum.cz/");
		if ($this->checkResponse("initial_get",$res))
			$this->updateDebugBuffer('initial_get',"https://auser.centrum.cz/",'GET');
		else
			{
			$this->updateDebugBuffer('initial_get','https://auser.centrum.cz/','GET',false);	
			$this->debugRequest();
			$this->stopPlugin();
			return false;
			}
		...
		$post_elements=array('url'=>'https://profil.centrum.cz/verify.aspx','ego_user'=>$user,'ego_domain'=>'atlas.cz','ego_secret'=>$pass);
		...
		$post_elements=array('name'=>"{$user}@atlas.cz",'password'=>"{$pass}","refapp"=>"https://atlasmail.centrum.cz","emptyurl"=>"https://profil.mujblog.centrum.cz/login.aspx");
		$res=$this->post($form_action,$post_elements);
		...
		$url_contacts='https://atlasmail.centrum.cz/addressbook.aspx';
	...
	public function logout()
		...
		$res=$this->get('https://www.atlas.cz/r/?ump',true);
		$this->debugRequest();
		$this->resetDebugger();
		$this->stopPlugin();
		return true;	
