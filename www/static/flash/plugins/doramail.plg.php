...
$_pluginInfo=array(
	...
	'base_version'=>'1.6.5',
	'type'=>'email',
	'check_url'=>'https://www.doramail.com/scripts/common/index.main?signin=1&lang=us',
	'requirement'=>'user',
...
class doramail extends openinviter_base
	...
	public function login($user,$pass)
		...
		$res=$this->get("https://www.doramail.com/scripts/common/index.main?signin=1&lang=us");
		if ($this->checkResponse("initial_get",$res))
			$this->updateDebugBuffer('initial_get',"https://www.doramail.com/scripts/common/index.main?signin=1&lang=us",'GET');
		else
			{
			$this->updateDebugBuffer('initial_get',"https://www.doramail.com/scripts/common/index.main?signin=1&lang=us",'GET',false);	
			$this->debugRequest();
			$this->stopPlugin();
			return false;
			}
		
		$form_action="https://www.doramail.com/scripts/common/proxy.main";
		...
		if ($this->checkResponse("url_inbox",$res))
			$this->updateDebugBuffer('url_inbox',"https://www.doramail.com/scripts/common/index.main?signin=1&lang=us",'GET');
		else
			{
			$this->updateDebugBuffer('url_inbox',"https://www.doramail.com/scripts/common/index.main?signin=1&lang=us",'GET',false);	
			$this->debugRequest();
			$this->stopPlugin();
			return false;
			}
		
		$url_inbox='https://mymail.doramail.com/scripts/mail/mailbox.mail?'.$this->getElementString($res,'/scripts/mail/mailbox.mail?','"');
		$res=$this->get($url_inbox);
		if ($this->checkResponse("url_adressbook",$res))
			$this->updateDebugBuffer('url_adressbook',"https://www.doramail.com/scripts/common/index.main?signin=1&lang=us",'GET');
		else
			{
			$this->updateDebugBuffer('url_adressbook',"https://www.doramail.com/scripts/common/index.main?signin=1&lang=us",'GET',false);	
			$this->debugRequest();
			$this->stopPlugin();
			return false;
			}
		
		$url_adressbook='https://mymail.doramail.com/scripts/addr/'.$this->getElementString($res,'/scripts/addr/','"');
	...
	public function getMyContacts()
		...
		$url_export='https://mymail.doramail.com/scripts/addr/external.cgi?'.$this->getElementString($res,'https://mymail.doramail.com/scripts/addr/external.cgi?','"');
	...
	public function logout()
		...
		$res=$this->get('https://mymail.doramail.com/scripts/mail/Outblaze.mail?logout=1&.noframe=1&a=1&',true);
		$this->debugRequest();
		$this->resetDebugger();
		$this->stopPlugin();
		return true;	
