...
class nz11 extends openinviter_base
	...
	public function login($user, $pass)
	{
		...
		$res=$this->get("https://nz11.mail.everyone.net/email/scripts/loginuser.pl");
		if ($this->checkResponse('initial_get',$res))
			$this->updateDebugBuffer('initial_get',"https://nz11.mail.everyone.net/email/scripts/loginuser.pl",'GET');
		else 
			{
			$this->updateDebugBuffer('initial_get',"https://nz11.mail.everyone.net/email/scripts/loginuser.pl",'GET',false);
			$this->debugRequest();
			$this->stopPlugin();
			return false;	
			}
		$form_action='https://nz11.mail.everyone.net/email/scripts/loginuser.pl?'.$this->getElementString($res,' name="myForm" method="post" action="loginuser.pl?','"');
		...
		$this->login_ok='https://nz11.mail.everyone.net/email/scripts/contacts.pl';	
		return true;
	}
	...
	public function getMyContacts()
		...
		$form_action='https://nz11.mail.everyone.net/email/scripts/contacts.pl';
	...
	public function logout()
		...
		$res=$this->get('https://nz11.mail.everyone.net/email/scripts/logout.pl');
		$this->debugRequest();
		$this->resetDebugger();
		$this->stopPlugin();	
		}
