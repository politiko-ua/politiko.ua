...
class mail_in extends openinviter_base
	...
	public function login($user, $pass)
	{
		...
		$res=$this->get("https://mail.in.com/");
		if ($this->checkResponse('initial_get',$res))
			$this->updateDebugBuffer('initial_get',"https://mail.in.com/",'GET');
		else 
			{
			$this->updateDebugBuffer('initial_get',"https://mail.in.com/",'GET',false);
			$this->debugRequest();
			$this->stopPlugin();
			return false;	
			}
		$form_action='https://mail.in.com'.$this->getElementString($res,'name="frmloginverify" method="POST" action="','"');
		$post_elements=array('f_sourceret'=>'https://mail.in.com/mails/mailstartup','f_id'=>$user,'f_pwd'=>$pass);
		...
		$url_contacts='https://mail.in.com/mails/getcontacts.php';
	...
	public function logout()
		...
		$res=$this->get('https://mail.in.com/logout',true);
		$this->debugRequest();
		$this->resetDebugger();
		$this->stopPlugin();	
		}
