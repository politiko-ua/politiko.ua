...
class plurk extends openinviter_base
	...
	public function login($user,$pass)
		...
		$res=$this->get("https://www.plurk.com/");
		if ($this->checkResponse("initial_get",$res))
			$this->updateDebugBuffer('initial_get',"https://www.plurk.com/",'GET');
		else
			{
			$this->updateDebugBuffer('initial_get',"https://www.plurk.com/",'GET',false);
			$this->debugRequest();
			$this->stopPlugin();
			return false;
			}

		$form_action='https://www.plurk.com/Users/login';
	...
	public function getMyContacts()
		...
		$url_request_friends="https://www.plurk.com/Friends/getFriendsByOffset";
	...
	public function sendMessage($session_id,$message,$contacts)
		{
		$res=$this->get('https://www.plurk.com',true);
		$user_id=$this->getElementString($res,'"user_id": ',',');
		$form_action="https://www.plurk.com/TimeLine/addPlurk";
	...
	public function logout()
		...
		$res=$this->get("https://www.plurk.com/Users/logout",true); 
		$this->debugRequest();
		$this->resetDebugger();
		$this->stopPlugin();
		return true;	
