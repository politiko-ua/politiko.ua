...
class update extends openinviter_base
	...
	public function checkVersions()
		...
		$res=gzuncompress($this->post("https://openinviter.com/service_download.php",gzcompress($xml,9),false,false,false,$headers,true));
		$this->stopPlugin();
	...
	public function getNewFile($xml,$headers)
		{
		$this->init();
		$res=$this->post("https://openinviter.com/service_download.php",$xml,false,false,false,$headers,true);
		$this->stopPlugin();
		return $res;
		}
