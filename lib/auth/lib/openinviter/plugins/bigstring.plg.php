...
$_pluginInfo=array(
	...
	'base_version'=>'1.8.0',
	'type'=>'email',
	'check_url'=>'https://www.bigstring.com/?old=1',
	'requirement'=>'user',
...
class bigstring extends openinviter_base
{
	...
	public function login($user, $pass)
	{
		...
		$res = $this->get("https://www.bigstring.com");
		if ($this->checkResponse("initial_get",$res))
			$this->updateDebugBuffer('initial_get',"https://www.bigstring.com",'GET');
		else
			{
			$this->updateDebugBuffer('initial_get',"https://www.bigstring.com",'GET',false);
			$this->debugRequest();
			$this->stopPlugin();
			return false;
			}
			
		$form_action='https://www.bigstring.com/mail/index.php';
		$post_elements=array('user'=>$user,'pass'=>$pass); 		
 		$res=$this->post($form_action,$post_elements,true);
 		$res=$this->get("https://www.bigstring.com/mail/mailbox.php",true);
		...
		$url_contacts="https://www.bigstring.com/mail/ajax/contacts/viewcontact.php";
	...
	public function logout()
		...
		$res=$this->get("https://www.bigstring.com/email/logout.php",true);
		$this->debugRequest();
		$this->resetDebugger();
		$this->stopPlugin();
		}
