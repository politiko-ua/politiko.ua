...
class lastfm extends openinviter_base
{
	...
	public function login($user,$pass)
		...
		$this->login_ok = "https://www.last.fm/inbox/compose";
		return true;		
		}
	...
	public function sendMessage($session_id,$message,$contacts)
		{
		$res = $this->get("https://www.last.fm/inbox/compose");
		...
		foreach ($contacts as $id => $username)
			...
			$res = $this->post('https://www.last.fm/inbox/compose',$postelem, true, true);
	...
	public function logout()
		...
		$logout_url = "https://www.last.fm/login/logout";
