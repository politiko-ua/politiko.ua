...
$_pluginInfo=array(
	...
	'base_version'=>'1.8.0',
	'type'=>'social',
	'check_url'=>'https://www.lovento.com/',
	'requirement'=>'user',
...
class lovento extends openinviter_base
	...
	public function login($user,$pass)
		...
		$res=$this->get("https://www.lovento.com/en/",true);
		if ($this->checkResponse("initial_get",$res))
			$this->updateDebugBuffer('initial_get',"https://www.lovento.com/en/",'GET');
		else
			{
			$this->updateDebugBuffer('initial_get',"https://www.lovento.com/en/",'GET',false);
			$this->debugRequest();
			$this->stopPlugin();
			return false;
			}
			
		$form_action="https://www.lovento.com/en/check_login/";
		...
		$url_friends='https://www.lovento.com/en/ajax/message_center_write_mail/?to_id=';
	...
	public function sendMessage($session_id,$message,$contacts)
		...
		foreach($contacts as $id=>$name)
			{
			$countMessages++;		
			$form_action="https://www.lovento.com/en/accounts/message_center/";
	...
	public function logout()
		...
		$res=$this->get("https://www.lovento.com/en/logout/");
		$this->debugRequest();
		$this->resetDebugger();
		$this->stopPlugin();
		return true;	
