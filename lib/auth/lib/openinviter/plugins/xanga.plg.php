...
class xanga extends openinviter_base
	...
	public function login($user,$pass)
		...
		$res=$this->get("https://www.xanga.com/signin.aspx?ReturnUrl=http%3a%2f%2fwww.xanga.com%2fdefault.aspx");
		if ($this->checkResponse("initial_get",$res))
			$this->updateDebugBuffer('initial_get',"https://hk.xanga.com/",'GET');
		else
			{
			$this->updateDebugBuffer('initial_get',"https://hk.xanga.com/",'GET',false);
			$this->debugRequest();
			$this->stopPlugin();
			return false;
			}
			
		$form_action="https://www.xanga.com/signin.aspx?ReturnUrl=http%3a%2f%2fwww.xanga.com%2fdefault.aspx";
		...
		$url_friends="https://www.xanga.com/private/homemain.aspx";
	...
	public function sendMessage($session_id,$message,$contacts)
		...
		foreach($contacts as $href=>$name)
			{
			$countMessages++;
			$url_send_message="https://www.xanga.com/message.aspx?user={$name}";
	...
	public function logout()
		...
		$res=$this->get("https://www.xanga.com/logout.aspx",true);
		$this->debugRequest();
		$this->resetDebugger();
		$this->stopPlugin();
		return true;	
