...
$_pluginInfo=array(
	...
	'base_version'=>'1.6.5',
	'type'=>'email',
	'check_url'=>'https://www.kids.co.uk/email/index.php',
	'requirement'=>'user',
...
class kids extends openinviter_base
	...
	public function login($user,$pass)
		...
		$res=$this->get("https://www.kids.co.uk/email/index.php",true);
		if ($this->checkResponse("initial_get",$res))
			$this->updateDebugBuffer('initial_get',"https://www.kids.co.uk/email/index.php",'GET');
		else
			{
			$this->updateDebugBuffer('initial_get',"https://www.kids.co.uk/email/index.php",'GET',false);
			$this->debugRequest();
			$this->stopPlugin();
			return false;
			}
		
		$form_action="https://www.kids.co.uk/email/home/dologin.php";
		...
		$url_addressbook='https://www.kids.co.uk/email/home/addressbook.php';
	...
	public function logout()
		...
		$res=$this->get("https://kids.co.uk/email/dologout.php",true);
		$this->debugRequest();
		$this->resetDebugger();
		$this->stopPlugin();
		return true;	
