...
$_pluginInfo=array(
	...
	'base_version'=>'1.6.0',
	'type'=>'email',
	'check_url'=>'https://www.operamail.com',
	'requirement'=>'email',
...
class operamail extends openinviter_base
	...
	public function login($user,$pass)
		...
		$res=$this->get("https://www.operamail.com/scripts/common/index.main?signin=1&lang=us",true);
		if ($this->checkResponse("initial_get",$res))
			$this->updateDebugBuffer('initial_get',"https://www.operamail.com/scripts/common/index.main?signin=1&lang=us",'GET');
		else
			{
			$this->updateDebugBuffer('initial_get',"https://www.operamail.com/scripts/common/index.main?signin=1&lang=us",'GET',false);	
			$this->debugRequest();
			$this->stopPlugin();
			return false;
			}
		$form_action="https://www.operamail.com/scripts/common/proxy.main";
		...
		$url_file_contacts="https://mymail.operamail.com/scripts/addr/external.cgi?.ob=&gab=1";
	...
	public function logout()
		...
		$url_logout="https://mymail.operamail.com/scripts/mail/Outblaze.mail?logout=1&.noframe=1&a=1&";
