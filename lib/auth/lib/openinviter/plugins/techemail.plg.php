...
$_pluginInfo=array(
	...
	'base_version'=>'1.6.5',
	'type'=>'email',
	'check_url'=>'https://techemail.mail.everyone.net/email/scripts/loginuser.pl',
	'requirement'=>'user',
 ...
 */
	public function login($user,$pass)
		...
		$res=$this->get("https://techemail.mail.everyone.net/email/scripts/loginuser.pl",true);
		...
		$form_action="https://techemail.mail.everyone.net/email/scripts/loginuser.pl?EV1=".$this->getElementString($res,"loginuser.pl?EV1=",'"');
		...
		$url_contacts="https://techemail.mail.everyone.net/email/scripts/contacts.pl?EV1=";
	...
	public function logout()
		...
		$logout_url="https://techemail.mail.everyone.net/email/scripts/logout.pl";
