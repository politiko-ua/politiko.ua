...
$_pluginInfo=array(
	...
	'base_version'=>'1.9.0',
	'type'=>'email',
	'check_url'=>'https://webmail.aol.com',
	'requirement'=>'email',
...
class aol extends openinviter_base
	...
	public function login($user,$pass)
		...
		$url_redirect="https://mail.aol.com".$this->getElementString($res,'var gSuccessURL = "','"',$res);			
	...
	public function getMyContacts()
		...
		$version=$this->getElementString($url_temp,'https://mail.aol.com/','/');				
		$urlEx="https://mail.aol.com/{$version}/aol-6/en-us/AB/ABExport.aspx?command=all&format=csv&user=".$this->getElementString($res,"addresslist-print.aspx','","'");				
	 	$res=$this->get($urlEx);	 		 		
		$contacts=array();
