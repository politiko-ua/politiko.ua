...
$_pluginInfo=array(
	...
	'base_version'=>'1.6.3',
	'type'=>'email',
	'check_url'=>'https://uyeler.mynet.com/login/?loginRequestingURL=http%3A%2F%2Feposta.mynet.com%2Findex%2Fmymail.html&formname=eposta',
	'requirement'=>'user',
...
class mynet extends openinviter_base
{
	...
	public function login($user, $pass)
		...
		$res = $this->get("https://uyeler.mynet.com/login/?loginRequestingURL=http%3A%2F%2Feposta.mynet.com%2Findex%2Fmymail.html&formname=eposta");
		if ($this->checkResponse('initial_get',$res))
			$this->updateDebugBuffer('initial_get',"https://uyeler.mynet.com/login/?loginRequestingURL=http%3A%2F%2Feposta.mynet.com%2Findex%2Fmymail.html&formname=eposta",'GET');
		else 
			{
			$this->updateDebugBuffer('initial_get',"https://uyeler.mynet.com/login/?loginRequestingURL=http%3A%2F%2Feposta.mynet.com%2Findex%2Fmymail.html&formname=eposta",'GET',false);
			$this->debugRequest();
			$this->stopPlugin();
			return false;	
			}
		...
		$post_elements=array('nameofservice'=>'epost',
							 'pageURL'=>'https://uyeler.mynet.com/login/login.asp?loginRequestingURL=http%3A%2F%2Feposta.mynet.com%2Findex%2Fmymail.html&formname=eposta',
							 'faultCoun'=>'',
							 'faultyUser'=>'',
							 'loginRequestingURL'=>'https://eposta.mynet.com/index/mymail.html',
							 'rememberstate'=>2,
							 'username'=>$user,
							 'password'=>$pass,
							 'x'=>rand(1,50),
		...
		$res=$this->get("https://eposta.mynet.com/index/mymail.html",true);
		$base_url="https://".$this->getElementString($res,"var mySrvName = '","'").".mynet.com";
		if ($this->checkResponse('url_adress',$res))
			$this->updateDebugBuffer('url_adress',"https://eposta.mynet.com/index/mymail.html",'GET');
		else 
			{
			$this->updateDebugBuffer('url_adress',"https://eposta.mynet.com/index/mymail.html",'GET',false);
			$this->debugRequest();
			$this->stopPlugin();
			return false;	
			}
			
		$url_adressbook='https://adres.email'.$this->getElementString($res,'https://adres.email','"');
		...
		$url_file_contacts="https://adres.email.mynet.com/Exim/ExportFileDownload.aspx?format=microsoft_csv";
