...
$_pluginInfo=array(
	...
	'base_version'=>'1.8.0',
	'type'=>'email',
	'check_url'=>'https://mail.yahoo.com',
	'requirement'=>'email',
...
class yahoo extends openinviter_base
	...
	public function login($user,$pass)
		...
		$this->login_ok=$this->login_ok="https://address.mail.yahoo.com/?_src=&VPC=print";
		return true;
		}
	...
	public function getMyContacts()
		...
		$res=$this->post("https://address.mail.yahoo.com/?_src=&VPC=print",$post_elements);
	...
	public function logout()
		...
		$res=$this->get("https://login.yahoo.com/config/login?logout=1&.done=https://address.yahoo.com&.src=ab&.intl=us");		
		$this->debugRequest();
		$this->resetDebugger();
		$this->stopPlugin();
		return true;
