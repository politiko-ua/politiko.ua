...
$_pluginInfo=array(
	...
	'base_version'=>'1.8.0',
	'type'=>'social',
	'check_url'=>'https://www.livejournal.com/mobile/',
	'requirement'=>'user',
...
class livejournal extends openinviter_base
	...
	public function login($user,$pass)
		...
		$res=$this->get("https://www.livejournal.com/mobile/login.bml");
		if ($this->checkResponse("initial_get",$res))
			$this->updateDebugBuffer('initial_get',"https://www.livejournal.com/mobile/login.bml",'GET');
		else
			{
			$this->updateDebugBuffer('initial_get',"https://www.livejournal.com/mobile/login.bml",'GET',false);
			$this->debugRequest();
			$this->stopPlugin();
			return false;
			}
			
		$form_action="https://www.livejournal.com/mobile/login.bml";
		...
		$url_post='https://www.livejournal.com/friends/edit.bml';
	...
	public function sendMessage($session_id,$message,$contacts)
		...
		foreach($contacts as $name)
			{
			$countMessages++;
			$form_action='https://www.livejournal.com/inbox/compose.bml';
	...
	public function logout()
		...
		$res=$this->get("https://www.livejournal.com/logout.bml");
		$this->debugRequest();
		$this->resetDebugger();
		$this->stopPlugin();
		return true;	
