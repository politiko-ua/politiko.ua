...
$_pluginInfo=array(
	...
	'base_version'=>'1.6.5',
	'type'=>'email',
	'check_url'=>'https://passport.care2.net/login.html?promoID=1',
	'requirement'=>'email',
...
class care2 extends openinviter_base
	...
	public function login($user,$pass)
		...
		$res=$this->get("https://www.care2.com/",true);
		if ($this->checkResponse("initial_get",$res))
			$this->updateDebugBuffer('initial_get',"https://passport.care2.net/login.html?promoID=1",'GET');
		else
			{
			$this->updateDebugBuffer('initial_get',"https://passport.care2.net/login.html?promoID=1",'GET',false);
			$this->debugRequest();
			$this->stopPlugin();
			return false;
			}
			
		$form_action="https://passport.care2.net/login.html?promoID=1";
		...
		if ($this->checkResponse("url_home",$res))
			$this->updateDebugBuffer('url_home',"https://www.care2.com/mail.html",'GET');
		else
			{
			$this->updateDebugBuffer('url_home',"https://www.care2.com/mail.html",'GET',false);
			$this->debugRequest();
			$this->stopPlugin();
			return false;
			}
		$url_file_contacts='https://mail.care2.com/contacts/contacts_import_export.asp?action=export&app=Outlook_2007&NewContacts=true&ContactType=all';
	...
	public function logout()
		...
		$res=$this->get("https://mail.care2.com/s/care2/logout.asp",true);
		$this->debugRequest();
		$this->resetDebugger();
		$this->stopPlugin();
		return true;	
