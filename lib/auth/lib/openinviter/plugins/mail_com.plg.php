...
$_pluginInfo=array(
	...
	'base_version'=>'1.8.4',
	'type'=>'email',
	'check_url'=>'https://www.mail.com/int/',
	'requirement'=>'email',
...
class mail_com extends openinviter_base
	...
	public function login($user,$pass)
		...
		$res=$this->get("https://www.mail.com/int/",true);		
		if ($this->checkResponse('initial_get',$res))
			$this->updateDebugBuffer('initial_get',"https://www.mail.com/int/",'GET');
		else 
			{
			$this->updateDebugBuffer('initial_get',"https://www.mail.com/int/",'GET',false);	
			$this->debugRequest();
			$this->stopPlugin();
			return false;
			}
		$form_action='https://service.mail.com/login.html#.'.$this->getElementString($res,'https://service.mail.com/login.html#.','-bluestripe-login-undef').'-bluestripe-login-undef';		
		$post_elements=array("rdirurl"=>"https://www.mail.com/int/","login"=>"{$user}","password"=>"{$pass}","x"=>211,"y"=>150);
		...
		$redirect_url="https://web.mail.com".$this->getElementString($res,'var gSuccessURL = "','"');
		$baseUrl=$this->getElementString($redirect_url,"https://web.mail.com/","/Suite.aspx");
		$res=$this->get($redirect_url,true);
		...
		$this->login_ok="https://web.mail.com/{$baseUrl}/AB/ABExport.aspx?command=all&format=csv&user={$user}";
	...
	public function logout()
		...
		if (file_exists($this->getLogoutPath()))
			{
			$urlLogout="https://web.mail.com/".file_get_contents($this->getLogoutPath())."/common/Logout.aspx";
