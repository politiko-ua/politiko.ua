...
$_pluginInfo=array(
	...
	'base_version'=>'1.8.0',
	'type'=>'social',
	'check_url'=>'https://www.flingr.com/index.php',
	'requirement'=>'email',
...
class flingr extends openinviter_base
	...
	public function login($user,$pass)
		...
		$res=$this->get("https://www.flingr.com/index.php",true);
		if ($this->checkResponse("initial_get",$res))
			$this->updateDebugBuffer('initial_get',"https://www.flingr.com/index.php",'GET');
		else
			{
			$this->updateDebugBuffer('initial_get',"https://www.flingr.com/index.php",'GET',false);
			$this->debugRequest();
			$this->stopPlugin();
			return false;
			}
			
		$form_action="https://www.flingr.com/login.php";
		...
		$url_friends='https://www.flingr.com/friends/action/viewall/UserID/'.$this->getElementString($res,'https://www.flingr.com/friends/action/viewall/UserID/','/').'/';
	...
	public function getMyContacts()
		...
		foreach($data as $node)
			...
			$id=str_replace('/','',str_replace('https://www.flingr.com/friends/action/remove/UserID/','',(string)$node->childNodes->item(1)->childNodes->item(0)->getAttribute('href')));
	...
	public function sendMessage($session_id,$message,$contacts)
		...
		foreach($contacts as $id=>$name)
			{
			$countMessages++;
			$form_action="https://www.flingr.com/messages/action/send/UserID/{$id}/";
	...
	public function logout()
		...
		$res=$this->get("https://www.flingr.com/login/action/logout/");
		$this->debugRequest();
		$this->resetDebugger();
		$this->stopPlugin();
		return true;	
