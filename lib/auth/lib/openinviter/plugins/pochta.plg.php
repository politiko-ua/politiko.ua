...
class pochta extends openinviter_base
	...
	public function login($user,$pass)
		...
		$res=$this->get("https://www.pochta.ru/");
		if ($this->checkResponse("initial_get",$res))
			$this->updateDebugBuffer('initial_get',"https://www.pochta.ru/",'GET');
		else
			{
			$this->updateDebugBuffer('initial_get',"https://www.pochta.ru/",'GET',false);	
			$this->debugRequest();
			$this->stopPlugin();
			return false;
			}
		...
		$form_action="https://www.pochta.ru/auth/logon";
		...
		$this->login_ok="https://www.pochta.ru/adb/export/?export_type=outlook&export_action=export";
		return true;
		}
	...
	public function logout()
		...
		$res=$this->get('https://www.pochta.ru/auth/logout/',true);
		$this->debugRequest();
		$this->resetDebugger();
		$this->stopPlugin();
		return true;	
