...
class eons extends openinviter_base
	...
	public function login($user,$pass)
		...
		$res=$this->get("https://www.eons.com/",true);
		if ($this->checkResponse("initial_get",$res))
			$this->updateDebugBuffer('initial_get',"https://www.eons.com/",'GET');
		else
			{
			$this->updateDebugBuffer('initial_get',"https://www.eons.com/",'GET',false);
			$this->debugRequest();
			$this->stopPlugin();
			return false;
			}
		...
		$post_elements=array('resource'=>'https://www.eons.com/','account[username]'=>$user,'account[password]'=>$pass,'permanent'=>1,'commit'=>'Log in');
		...
		$url_home="https://www.eons.com/my_eons";
		...
		$url_friends='https://www.eons.com/members/friends/'.$this->getElementString($res,'/members/friends/','"');
	...
	public function sendMessage($session_id,$message,$contacts)
		...
		foreach($contacts as $name)
			{
			$countMessages++;	
			$form_action="https://www.eons.com/messages/write";
			$post_elements=array('ref'=>"https://www.eons.com/members/profile/{$name}",
