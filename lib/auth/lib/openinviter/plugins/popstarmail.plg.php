...
$_pluginInfo=array(
	...
	'base_version'=>'1.6.5',
	'type'=>'email',
	'check_url'=>'https://super.popstarmail.org/',
	'requirement'=>'email',
 ...
 */
	public function login($user,$pass)
		...
		$res=$this->get("https://super.popstarmail.org/",true);
		if ($this->checkResponse('initial_get',$res))
			$this->updateDebugBuffer('initial_get',"https://super.popstarmail.org/",'GET');
		else
			{
			$this->updateDebugBuffer('initial_get',"https://super.popstarmail.org/",'GET',false);
			$this->debugRequest();
			$this->stopPlugin();
			return false;
			}
		
		$form_action="https://super.popstarmail.org/scripts/common/ss_main.cgi";
		...
		$url_export="https://mymail.hk.popstarmail.org/scripts/addr/external.cgi?.ob={$sid}&gab=1";
	...
	public function logout()
		...
		$logout_url="https://mymail.hk.popstarmail.org/scripts/mail/Outblaze.mail?logout=1&.noframe=1&a=1&";
