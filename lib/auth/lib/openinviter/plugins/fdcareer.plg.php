...
$_pluginInfo=array(
	...
	'base_version'=>'1.8.0',
	'type'=>'social',
	'check_url'=>'https://www.fdcareer.com/user/login',
	'requirement'=>'email',
...
class fdcareer extends openinviter_base
	...
	public function login($user,$pass)
		...
		$res=$this->get("https://www.fdcareer.com/user/login",true);
		...
		$form_action="https://www.fdcareer.com/user/do_login";
		...
		$url_friends='https://www.fdcareer.com/my/friends';
	...
	public function sendMessage($session_id,$message,$contacts)
		...
		foreach($contacts as $href=>$name)
			...
			$form_action="https://www.fdcareer.com/my/inbox/send/0";
	...
	public function logout()
		...
		$res=$this->get("https://www.fdcareer.com/user/logout");
		$this->debugRequest();
		$this->resetDebugger();
		$this->stopPlugin();
		return true;	
