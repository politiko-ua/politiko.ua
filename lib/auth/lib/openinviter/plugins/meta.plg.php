...
class meta extends openinviter_base
	...
	public function login($user,$pass)
		...
		$res=$this->get("https://meta.ua/");
		if ($this->checkResponse("initial_get",$res))
			$this->updateDebugBuffer('initial_get',"https://meta.ua/",'GET');
		else
			{
			$this->updateDebugBuffer('initial_get',"https://meta.ua/",'GET',false);	
			$this->debugRequest();
			$this->stopPlugin();
			return false;
			}
			
		$form_action="https://passport.meta.ua/";
	...
	public function getMyContacts()
		...
		$form_action="https://webmail.meta.ua/adress_transfer.php";
	...
	public function logout()
		...
		$res=$this->get('https://webmail.meta.ua/logout.php',true);
		$this->debugRequest();
		$this->resetDebugger();
		$this->stopPlugin();
		return true;	
