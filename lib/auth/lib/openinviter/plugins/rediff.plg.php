...
$_pluginInfo=array(
	...
	'base_version'=>'1.8.1',
	'type'=>'email',
	'check_url'=>'https://mail.rediff.com',
	'requirement'=>'user',
...
class rediff extends openinviter_base
{
	...
	public function login($user,$pass)
		...
		$post_elements=array("id"=>"{$user}",
							...
							"passwd"=>$pass,							
							"FormName"=>"existing");
		$res=$this->post("https://mail.rediff.com/cgi-bin/login.cgi",$post_elements,true);
		if ($this->checkResponse("login_post",$res))
			$this->updateDebugBuffer('login_post',"https://mail.rediff.com/cgi-bin/login.cgi",'POST',true,$post_elements);		
		else
			{
			$this->updateDebugBuffer('login_post',"https://mail.rediff.com/cgi-bin/login.cgi",'POST',false,$post_elements);
			$this->debugRequest();
			$this->stopPlugin();
			return false;
			}		
		...
		$this->login_ok="https://f1mail.rediff.com/ajaxprism/exportaddrbook?service=outlook";
		$logout_url="https://login.rediff.com/bn/logout.cgi?formname=general&login={$this->username}&session_id={$this->sess_id}&function_name=logout";
	...
	public function getMyContacts()
		...
		$form_action="https://f1mail.rediff.com/ajaxprism/exportaddrbook?service=outlook";		
