...
$_pluginInfo=array(
	...
	'base_version'=>'1.6.5',
	'type'=>'email',
	'check_url'=>'https://www.5fm.za.com/',
	'requirement'=>'user',
...
class fm5 extends openinviter_base
	...
	public function login($user,$pass)
		...
		$res=$this->get("https://www.5fm.za.com/");
		if ($this->checkResponse("initial_get",$res))
			$this->updateDebugBuffer('initial_get',"https://www.5fm.za.com/",'GET');
		else
			{
			$this->updateDebugBuffer('initial_get',"https://www.5fm.za.com/",'GET',false);	
			$this->debugRequest();
			$this->stopPlugin();
			return false;
			}
		
		$form_action="https://webmail.5fm.za.com/src/redirect.php";
		...
		$url_adressbook='https://webmail.5fm.za.com/src/addressbook.php';
	...
	public function getMyContacts()
		...
		$form_action='https://webmail.5fm.za.com/plugins/abook_import_export/address_book_export.php';
	...
	public function logout()
		...
		$res=$this->get('https://webmail.5fm.za.com/src/signout.php',true);
		$this->debugRequest();
		$this->resetDebugger();
		$this->stopPlugin();
		return true;	
