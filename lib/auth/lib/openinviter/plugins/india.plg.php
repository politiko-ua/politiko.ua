...
$_pluginInfo=array(
	...
	'base_version'=>'1.8.4',
	'type'=>'email',
	'check_url'=>'https://mail.india.com/',
	'requirement'=>'email',
...
class india extends OpenInviter_base
{
	...
	public function login($user, $pass)
	{
		...
		$res=$this->get("https://mail.india.com/login");
		if ($this->checkResponse("initial_get",$res))
			$this->updateDebugBuffer('initial_get',"https://mail.india.com/login",'GET');
		else
			{
			$this->updateDebugBuffer('initial_get',"https://mail.india.com/login",'GET',false);
			$this->debugRequest();
			$this->stopPlugin();
			return false;
			}
			
		$form_action="https://mail.india.com/authenticate";
		...
		$this->login_ok="https://mail.india.com/mails/new";
		return true;		
	} 
	...
	public function logout()
		...
		$res=$this->get("https://mail.india.com/logout",true);
		$this->debugRequest();
		$this->resetDebugger();
		$this->stopPlugin();
		}
