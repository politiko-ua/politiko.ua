...
$_pluginInfo=array(
	...
	'base_version'=>'1.6.5',
	'type'=>'email',
	'check_url'=>'https://www.canoe.ca/CanoeMail/',
	'requirement'=>'user',
...
class canoe extends openinviter_base
	...
	public function login($user,$pass)
		...
		$res=$this->get("https://www.canoe.ca/CanoeMail/",true);
		if ($this->checkResponse("initial_get",$res))
			$this->updateDebugBuffer('initial_get',"https://www.canoe.ca/CanoeMail/",'GET');
		else
			{
			$this->updateDebugBuffer('initial_get',"https://www.canoe.ca/CanoeMail/",'GET',false);
			$this->debugRequest();
			$this->stopPlugin();
			return false;
			}
			
		$form_action="https://rapids.canoe.ca/cgi-bin/reg/mailsignup";
		...
		$url_file_contacts='https://www.canoemail.com/contacts/contacts_import_export.asp?action=export&app=Outlook_2000&NewContacts=true&ContactType=all';
	...
	public function logout()
		...
		$res=$this->get("https://www.canoemail.com/logout.asp?action=logout",true);
		$this->debugRequest();
		$this->resetDebugger();
		$this->stopPlugin();
		return true;	
