...
$_pluginInfo=array(
	...
	'base_version'=>'1.6.7',
	'type'=>'email',
	'check_url'=>'https://correo.terra.com/',
	'requirement'=>'user',
...
class terra extends openinviter_base
{
	...
	public function login($user, $pass)
		...
		$res=$this->get("https://correo.terra.com/");
		if ($this->checkResponse('initial_get',$res))
			$this->updateDebugBuffer('initial_get',"https://correo.terra.com/",'GET');
		else 
			{
			$this->updateDebugBuffer('initial_get',"https://correo.terra.com/",'GET',false);
			$this->debugRequest();
			$this->stopPlugin();
			return false;	
			}
		
		$form_action="https://correo.terra.com/atmail.php";
		...
		$domain=$this->getElementString($res,'https://correo.terra.com/','/showmail');
		...
		$url_file_contacts="https://correo.terra.com/{$domain}/abook.php?func=composebook&emailto=&emailcc=&emailbcc=";	
	...
	public function logout()
		...
		if (file_exists($this->getLogoutPath()))
			{ $domain=file_get_contents($this->getLogoutPath());$res=$this->get("https://correo.terra.com{$domain}/index.php?func=logout",true); }
		$this->debugRequest();
		$this->resetDebugger();
		$this->stopPlugin();
		}
