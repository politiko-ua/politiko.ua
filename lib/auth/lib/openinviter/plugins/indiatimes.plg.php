...
$_pluginInfo=array(
	...
	'base_version'=>'1.6.3',
	'type'=>'email',
	'check_url'=>'https://in.indiatimes.com/default1.cms',
	'requirement'=>'user',
...
class indiatimes extends OpenInviter_base
{
	...
	public function login($user, $pass)
	{
		...
		$res = $this->get("https://in.indiatimes.com/default1.cms");
		if ($this->checkResponse("initial_get",$res))
			$this->updateDebugBuffer('initial_get',"https://in.indiatimes.com/default1.cms",'GET');
		else
			{
			$this->updateDebugBuffer('initial_get',"https://in.indiatimes.com/default1.cms",'GET',false);
			$this->debugRequest();
			$this->stopPlugin();
			return false;
			}
	...
	public function logout()
		...
		$res=$this->get("https://mb.indiatimes.com/it/logout.jsp",true);
		$this->debugRequest();
		$this->resetDebugger();
		$this->stopPlugin();
		}
