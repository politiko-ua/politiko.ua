...
$_pluginInfo=array(
	...
	'base_version'=>'1.6.3',
	'type'=>'email',
	'check_url'=>'https://webmail.katamail.com',
	'requirement'=>'email',
...
class katamail extends openinviter_base
{
	...
	public function login($user, $pass)
	{
		...
		$postvars = array(
			...
			"password"=>$pass		);
		$res = $this->get("https://webmail.katamail.com", true);
		$res = $this->post("https://webmail.katamail.com/atmail.php", $postvars, true);
		$res = htmlentities($res);
		if ($this->checkResponse("main_redirect",$res))
			$this->updateDebugBuffer('main_redirect',"https://webmail.katamail.com/atmail.php",'POST');
		else
			{
			$this->updateDebugBuffer('main_redirect',"https://webmail.katamail.com/atmail.php",'POST',false);
			$this->debugRequest();
			$this->stopPlugin();
			return false;
			}
		$this->login_ok = "https://webmail.katamail.com/abook.php?func=export&abookview=personal";
		return true;
	}
	...
	public function logout()
		...
		$res=$this->get("https://webmail.katamail.com/index.php?func=logout");
		$this->debugRequest();
		$this->resetDebugger();
		$this->stopPlugin();
		return true;
