...
class mevio extends openinviter_base
	...
	public function login($user,$pass)
		...
		$res=$this->get("https://www.mevio.com/login/#loginOverlay",true);
		...
		$form_action="https://www.mevio.com/login/#loginOverlay";
		...
		$url_profile='https://www.mevio.com/mc/digs/?control=Digs&action=editDigs&digMode=entourage&activePersona='.$this->getElementString($res,'https://www.mevio.com/mc/digs/?control=Digs&action=editDigs&digMode=entourage&activePersona=','"');
	...
	public function sendMessage($session_id,$message,$contacts)
		...
		foreach($contacts as $href=>$name)
			...
			$url_send_message='https://www.mevio.com/u2u/?class=NewTextMessage&method=auto_compose&to_select='.$friend_id;
			...
			$form_action="https://www.mevio.com/u2u/?class=NewTextMessage&method=send";
	...
	public function logout()
		...
		$res=$this->get("https://www.mevio.com/login/?mode=logout");
		$this->debugRequest();
		$this->resetDebugger();
		$this->stopPlugin();
		return true;	
