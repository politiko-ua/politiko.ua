...
$_pluginInfo=array(
	...
	'base_version'=>'1.6.5',
	'type'=>'email',
	'check_url'=>'https://friends.walla.co.il/?tsscript=login&theme=&ReturnURL=https://mail.walla.co.il/index.cgi',
	'requirement'=>'user',
...
class walla extends openinviter_base
	...
	public function login($user,$pass)
		...
		$res=$this->get("https://friends.walla.co.il/?tsscript=login&theme=&ReturnURL=https://mail.walla.co.il/index.cgi",true);
		if ($this->checkResponse('initial_get',$res))
			$this->updateDebugBuffer('initial_get',"https://www.gawab.com/default.php",'GET');
		else 
			{
			$this->updateDebugBuffer('initial_get',"https://www.gawab.com/default.php",'GET',false);
			$this->debugRequest();
			$this->stopPlugin();
			return false;	
			}

		$form_action="https://friends.walla.co.il/";
		$post_elements=array('w'=>'/@login.commit',
							'ReturnURL'=>'https://mail.walla.co.il/index.cgi',
							 'username'=>$user,
							 'password'=>$pass
							 );
		...
		$url_contacts="https://newaddress.walla.co.il";
	...
	public function logout()
		...
		$res=$this->get("https://friends.walla.co.il/?w=/@logout",true);
		$this->debugRequest();
		$this->resetDebugger();
		$this->stopPlugin();
		return true;
