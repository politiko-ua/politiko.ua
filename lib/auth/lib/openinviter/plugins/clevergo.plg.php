...
$_pluginInfo=array(
	...
	'base_version'=>'1.8.0',
	'type'=>'email',
	'check_url'=>'https://www.clevergo.com/index.php',
	'requirement'=>'user',
...
class clevergo extends openinviter_base
	...
	public function login($user,$pass)
		...
		$res=$this->get("https://www.clevergo.com/index.php");
		...
		$form_action="https://www.clevergo.com/index.php?action=login";
	...
	public function getMyContacts()
		...
		$form_action="https://www.clevergo.com/organizer.addressbook.php?action=exportAddressbook&sid={$sid}";
	...
	public function logout()
		...
		if (file_exists($this->getLogoutPath()))
			...
			$res=$this->get("https://www.clevergo.com/start.php?sid={$sid}&action=logout",true);
			}	
		$this->debugRequest();
		$this->resetDebugger();
		$this->stopPlugin();
