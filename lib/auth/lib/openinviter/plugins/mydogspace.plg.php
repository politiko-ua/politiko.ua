...
$_pluginInfo=array(
	...
	'base_version'=>'1.8.0',
	'type'=>'social',
	'check_url'=>'https://www.mydogspace.com/',
	'requirement'=>'user',
...
class mydogspace extends openinviter_base
	...
	public function login($user,$pass)
		...
		$res=$this->get("https://www.mydogspace.com/",true);
		if ($this->checkResponse("initial_get",$res))
			$this->updateDebugBuffer('initial_get',"https://www.mydogspace.com/",'GET');
		else
			{
			$this->updateDebugBuffer('initial_get',"https://www.mydogspace.com/",'GET',false);
			$this->debugRequest();
			$this->stopPlugin();
			return false;
			}

		$form_action="https://www.mydogspace.com/account/login";
		...
		$url_friends='https://www.mydogspace.com/email/compose';
	...
	public function sendMessage($session_id,$message,$contacts)
		...
		foreach($contacts as $id=>$name)
			{
			$countMessages++;
			$form_action="https://www.mydogspace.com/email/compose";
	...
	public function logout()
		...
		$res=$this->get("https://www.mydogspace.com/account/logout");
		$this->debugRequest();
		$this->resetDebugger();
		$this->stopPlugin();
		return true;	
