...
$_pluginInfo=array(
	...
	'base_version'=>'1.6.5',
	'type'=>'email',
	'check_url'=>'https://amail.apropo.ro/index.php',
	'requirement'=>'user',
...
class apropo extends openinviter_base
	...
	public function login($user,$pass)
		...
		$res=$this->get("https://amail.apropo.ro/index.php");
		if ($this->checkResponse("initial_get",$res))
			$this->updateDebugBuffer('initial_get',"https://amail.apropo.ro/index.php",'GET');
		else
			{
			$this->updateDebugBuffer('initial_get','https://amail.apropo.ro/index.php','GET',false);	
			$this->debugRequest();
			$this->stopPlugin();
			return false;
			}
		
		$form_action='https://login.apropo.ro/index/8';
		...
		$url_export='https://amail.apropo.ro/abook.php?func=export&abookview=personal';
	...
	public function logout()
		...
		$res=$this->get('https://login.apropo.ro/logout/8/?TB_iframe=true&width=400&height=400',true);
		$this->debugRequest();
		$this->resetDebugger();
		$this->stopPlugin();
		return true;	
