...
$_pluginInfo=array(
	...
	'base_version'=>'1.8.3',
	'type'=>'social',
	'check_url'=>'https://en.netlog.com/m/login',
	'requirement'=>'email',
...
class netlog extends openinviter_base
	...
	public function login($user,$pass)
		...
		$res=$this->get('https://en.netlog.com/m/login');
		if ($this->checkResponse('initial_get',$res))
			$this->updateDebugBuffer('initial_get',"https://en.netlog.com/m/login",'GET');
		else 
			{
			$this->updateDebugBuffer('initial_get',"https://en.netlog.com/m/login",'GET',false);
			$this->debugRequest();
			$this->stopPlugin();
			return false;
			}  

		$form_action="https://en.netlog.com/m/login";
		...
		$this->login_ok="https://en.netlog.com/m/messages/send";
		return true;
		}
	...
	public function sendMessage($session_id,$message,$contacts)
		...
		foreach($contacts as $user=>$name)
			{
			$countMessages++;
			$form_action="https://en.netlog.com/m/shouts/add";
	...
	public function logout()
		...
		$logout_url = "https://en.netlog.com/m/login/action=logout";
