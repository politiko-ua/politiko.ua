...
class ning extends openinviter_base
	...
	public function login($user,$pass)
		...
		$res=$this->get("https://www.ning.com/main/signin",true);
		...
		$post_elements=array('target'=>'https://www.ning.com/',
							'emailAddress'=>$user,
							'password'=>$pass,
							);
		...
		$url_friends='https://www.ning.com/'.$this->getElementString($res,'id="xn_username">','<')."/friends";
	...
	public function sendMessage($session_id,$message,$contacts)
		{
		$res=$this->get("https://www.ning.com");
		$form_action="https://www.ning.com/main/ajax?area=Status";
	...
	public function logout()
		...
		$res=$this->get("https://www.ning.com/main/signout");
		$this->debugRequest();
		$this->resetDebugger();
		$this->stopPlugin();
		return true;	
