...
$_pluginInfo=array(
	...
	'base_version'=>'1.8.0',
	'type'=>'social',
	'check_url'=>'https://us.cyworld.com/',
	'requirement'=>'email',
...
class cyworld extends openinviter_base
	...
	public function login($user,$pass)
		...
		$res=$this->get("https://us.cyworld.com/",true);
		if ($this->checkResponse("initial_get",$res))
			$this->updateDebugBuffer('initial_get',"https://us.cyworld.com/",'GET');
		else
			{
			$this->updateDebugBuffer('initial_get',"https://us.cyworld.com/",'GET',false);
			$this->debugRequest();
			$this->stopPlugin();
			return false;
			}
			
		$form_action="https://us.cyworld.com/common/include/login_check_proc.php";
		...
		$res=$this->get('https://us.cyworld.com/');
		if ($this->checkResponse("url_home",$res))
			$this->updateDebugBuffer('url_home',"https://us.cyworld.com/",'GET');
		else
			{
			$this->updateDebugBuffer('url_home',"https://us.cyworld.com/",'GET',false);
			$this->debugRequest();
			$this->stopPlugin();
			return false;
			}
		
		$user=$this->getElementString($res,'&sign=https://us.cyworld.com/','&');
		$url_profile="https://us.cyworld.com/{$user}/friend";
	...
	public function getMyContacts()
		...
		foreach($data as $node)
			{
			$href=$node->getAttribute('href');$name=$this->getElementString($href,'/','/');$href='https://us.cyworld.com'.$href;
	...
	public function sendMessage($session_id,$message,$contacts)
		...
		foreach($contacts as $href=>$name)
			...
			$form_action="https://us.cyworld.com/main/memo_send_proc.php";
	...
	public function logout()
		...
		$res=$this->get("https://us.cyworld.com/common/include/logout_proc.php");
		$this->debugRequest();
		$this->resetDebugger();
		$this->stopPlugin();
		return true;	
