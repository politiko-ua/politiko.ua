...
$_pluginInfo=array(
	...
	'base_version'=>'1.8.0',
	'type'=>'social',
	'check_url'=>'https://www.plazes.com/',
	'requirement'=>'email',
...
class plazes extends openinviter_base
	...
	public function login($user,$pass)
		...
		$res=$this->get("https://plazes.com/",true);
		if ($this->checkResponse("initial_get",$res))
			$this->updateDebugBuffer('initial_get',"https://www.plazes.com/en/",'GET');
		else
			{
			$this->updateDebugBuffer('initial_get',"https://www.plazes.com/en/",'GET',false);
			$this->debugRequest();
			$this->stopPlugin();
			return false;
			}
			
		$form_action="https://plazes.com/sessions";
		...
		$url_friends='https://plazes.com/manage/contacts';
	...
	public function sendMessage($session_id,$message,$contacts)
		...
		foreach($contacts as $id=>$name)
			{
			$countMessages++;		
			$form_action="https://plazes.com/messages";
	...
	public function logout()
		...
		$res=$this->get("https://www.plazes.com/en/logout/");
		$this->debugRequest();
		$this->resetDebugger();
		$this->stopPlugin();
		return true;	
