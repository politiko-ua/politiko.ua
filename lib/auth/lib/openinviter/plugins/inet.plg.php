...
$_pluginInfo=array(
	...
	'base_version'=>'1.6.5',
	'type'=>'email',
	'check_url'=>'https://inet.ua/index.php',
	'requirement'=>'email',
...
class inet extends openinviter_base
	...
	public function login($user,$pass)
		...
		$res=$this->get("https://inet.ua/index.php");
		if ($this->checkResponse("initial_get",$res))
			$this->updateDebugBuffer('initial_get',"https://inet.ua/index.php",'GET');
		else
			{
			$this->updateDebugBuffer('initial_get',"https://inet.ua/index.php",'GET',false);	
			$this->debugRequest();
			$this->stopPlugin();
			return false;
			}
		...
		$form_action="https://newmail.inet.ua/login.php";
		...
		$this->login_ok="https://newmail.inet.ua/download.php?act=process_export&method=csv&addresses=all";
		return true;
		}
	...
	public function logout()
		...
		$res=$this->get('https://newmail.inet.ua/logout.php?vwebmailsession=',true);
		$this->debugRequest();
		$this->resetDebugger();
		$this->stopPlugin();
		return true;	
