...
$_pluginInfo=array(
	...
	'base_version'=>'1.8.0',
	'type'=>'social',
	'check_url'=>'https://www.motortopia.com/main/cars',
	'requirement'=>'email',
...
class motortopia extends openinviter_base
	...
	public function login($user,$pass)
		...
		$res=$this->get("https://www.motortopia.com/main/cars",true);
		if ($this->checkResponse("initial_get",$res))
			$this->updateDebugBuffer('initial_get',"https://www.motortopia.com/en/",'GET');
		else
			{
			$this->updateDebugBuffer('initial_get',"https://www.motortopia.com/en/",'GET',false);
			$this->debugRequest();
			$this->stopPlugin();
			return false;
			}
			
		$form_action="https://www.motortopia.com/user/login/main/y";
		...
		$url_friends='https://www.motortopia.com/friend/browse/u/'.$this->getElementString($res,'/friend/browse/u/','"');
	...
	public function sendMessage($session_id,$message,$contacts)
		...
		foreach($contacts as $name)
			{			
			$countMessages++;
			$form_action="https://www.motortopia.com/mail/send/{$name}";
	...
	public function logout()
		...
		$res=$this->get("https://www.motortopia.com/user/logout");
		$this->debugRequest();
		$this->resetDebugger();
		$this->stopPlugin();
		return true;	
