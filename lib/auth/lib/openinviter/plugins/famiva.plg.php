...
$_pluginInfo=array(
	...
	'base_version'=>'1.8.0',
	'type'=>'social',
	'check_url'=>'https://www.famiva.com/',
	'requirement'=>'email',
...
class famiva extends openinviter_base
	...
	public function login($user,$pass)
		...
		$res=$this->get("https://www.famiva.com/",true);
		if ($this->checkResponse("initial_get",$res))
			$this->updateDebugBuffer('initial_get',"https://www.famiva.com/",'GET');
		else
			{
			$this->updateDebugBuffer('initial_get',"https://www.famiva.com/",'GET',false);
			$this->debugRequest();
			$this->stopPlugin();
			return false;
			}
			
		$form_action="https://famiva.com/login/login";
		...
		$url_friends='https://famiva.com/members/explore';
	...
	public function logout()
		...
		$res=$this->get("https://www.famiva.com/login/logout");
		$this->debugRequest();
		$this->resetDebugger();
		$this->stopPlugin();
		return true;	
