...
class gmx_net extends openinviter_base
	...
	public function login($user,$pass)
		...
		$res=$this->get("https://www.gmx.net/",true);
		if ($this->checkResponse("initial_get",$res))
			$this->updateDebugBuffer('file_contacts',"https://www.gmx.net/",'GET');
		else
			{
			$this->updateDebugBuffer('file_contacts',"https://www.gmx.net/",'GET',false);	
			$this->debugRequest();
			$this->stopPlugin();
			return false;
			}
		...
		$url_adress=str_replace("site=0","site=importexport","https://service.gmx.net/de/cgi/addrbk.fcgi?CUSTOMERNO=".html_entity_decode($this->getElementString($res,'https://service.gmx.net/de/cgi/addrbk.fcgi?CUSTOMERNO=','"')));
		#echo $url_adress;
	...
	public function getMyContacts()
		...
		$form_action="https://service.gmx.net/de/cgi/addrbk.fcgi";
