...
$_pluginInfo=array(
	...
	'base_version'=>'1.6.7',
	'type'=>'email',
	'check_url'=>'https://services.mail.sapo.pt/codebits/',
	'requirement'=>'email',
...
class sapo extends openinviter_base
	...
	public function login($user,$pass)
		...
		$res=$this->get("https://services.mail.sapo.pt/codebits/");
		if ($this->checkResponse("initial_get",$res))
			$this->updateDebugBuffer('initial_get',"https://services.mail.sapo.pt/codebits/",'GET');
		else
			{
			$this->updateDebugBuffer('initial_get',"https://services.mail.sapo.pt/codebits/",'GET',false);
			$this->debugRequest();
			$this->stopPlugin();
			return false;
			}			
	...
	public function getMyContacts()
		...
		$form_action="https://services.mail.sapo.pt/codebits/index.php";
