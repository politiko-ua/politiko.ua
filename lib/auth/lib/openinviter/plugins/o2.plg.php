...
class o2 extends openinviter_base
	...
	public function login($user,$pass)
		...
		$res=$this->get("https://poczta.o2.pl/");
		if ($this->checkResponse('initial_get',$res))
			$this->updateDebugBuffer('initial_get',"https://www.fastmail.fm/",'GET');
		else 
			{
			$this->updateDebugBuffer('initial_get',"https://www.fastmail.fm/",'GET',false);
			$this->debugRequest();
			$this->stopPlugin();
			return false;	
			}
		...
		$url_export="https://poczta.o2.pl/a?cmd=export_addressbook&requestid=2&xsfr-cookie={$sesid}&fmt=xml&upid=&";		
