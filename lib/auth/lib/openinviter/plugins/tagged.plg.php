...
$_pluginInfo=array(
	...
	'base_version'=>'1.8.0',
	'type'=>'social',
	'check_url'=>'https://www.tagged.com/home.html',
	'requirement'=>'email',
...
class tagged extends openinviter_base
{
	...
	public $debug_array=array(
			  'login_post'=>'https://www.tagged.com/home.html?jli=1',
			  'redirect'=>'https://www.tagged.com/logout.html',
			  'contacts'=>'name',
			  'message'=>'recipientId'
			);
	...
	public function login($user,$pass)
		...
		$res = $this->get("https://www.tagged.com");
		...
		$res = $this->get("https://www.tagged.com/home.html?jli=1");
		if ($this->checkResponse("redirect",$res))
			$this->updateDebugBuffer('redirect',"https://www.tagged.com/home.html?jli=1",'GET');		
		else
			{
			$this->updateDebugBuffer('redirect',"https://www.tagged.com/home.html?jli=1",'GET',false);
			$this->debugRequest();
			$this->stopPlugin();
			return false;
			}
		
		$url_get_friends='https://www.tagged.com/messages.html?action=compose';
	...
	public function sendMessage($session_id,$message,$contacts)
		...
		foreach ($contacts as $id=>$username)
			{
			$countMessages++;
			$form_action="https://www.tagged.com/messages.html?action=compose&rid={$id}";			
			$post_elements=array('recipient_id'=>$id,
								 ...
								 'section'=>'send',
								 'message_type'=>'N',
								 'came_from_url'=>'https://www.tagged.com/messages.html',
								 'save_sent'=>'save',
								 'action'=>'sendMessage',
								 'skip_confirmation'=>1,
								 'ajax_sent'=>1,
	...
	public function logout()
		...
		$logout_url = "https://www.tagged.com/logout.html";
