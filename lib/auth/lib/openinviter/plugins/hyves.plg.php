...
$_pluginInfo=array(
	...
	'base_version'=>'1.8.1',
	'type'=>'social',
	'check_url'=>'https://www.hyves.nl/?l1=mo',
	'requirement'=>'user',
	'allowed_domains'=>false,
	);
/**
 * https://hyves.net/ Plugin
 * 
...
class hyves extends openinviter_base
	...
	public function login($user,$pass)
		...
		$res=$this->get("https://www.hyves.nl/?l1=mo");
		if ($this->checkResponse("initial_get",$res))
			$this->updateDebugBuffer('initial_get',"https://www.hyves.nl/?l1=mo",'GET');
		else
			{
			$this->updateDebugBuffer('initial_get',"https://www.hyves.nl/?l1=mo",'GET',false);
			$this->debugRequest();
			$this->stopPlugin();
			return false;
			}			
		...
		$url_logout='https://www.hyves.nl/?module=authentication&action=logoutMobile'.html_entity_decode($this->getElementString($res,"?module=authentication&amp;action=logoutMobile",'"'));
		$url_friends="https://www.hyves.nl/mini/hyver/{$user}/friends";
	...
	public function getMyContacts()
		...
		while ($hasContacts)
			...
			$page=$page+10;
			$urlNext="https://www.hyves.nl/mini/hyver/{$this->service_user}/friends/?&startpos={$page}";
	...
	public function sendMessage($session_id,$message,$contacts)
		...
		foreach($contacts as $href=>$name)
			...
			$url_send_message='https://www.hyves.nl'.urldecode($url_send_message_array[0]);
			...
			$form_action="https://www.hyves.nl/?l1=mo&l2=mb&l3=hm&l4=sendi";
			$post_elements=array(
