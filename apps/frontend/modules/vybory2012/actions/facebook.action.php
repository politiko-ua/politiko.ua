...
class vybory2012_facebook_action extends vybory2012_controller
{
	public function execute()
	{
                ...
                if ($fb_id) {
                        ...
                        //{
                            if ($user['id']>0)
                            {
                                votes2012_peer::instance()->remove_votes($user['id']);
                        ...
                        //}
                        $this->redirect('https://www.facebook.com/sharer.php?u=https://'.context::get('server').'/vybory2012/party?id='.$party_id);
