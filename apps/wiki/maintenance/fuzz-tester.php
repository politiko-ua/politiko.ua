...
* @file
* @ingroup Maintenance
* @author Nick Jenkins ( https://nickj.org/ ).
...
Background:
  ...
  - https://www.securiteam.com/tools/6Z00N1PBFK.html
  - https://www.securityfocus.com/archive/1/378632/2004-10-15/2004-10-21/0

Video:
  There's an XviD video discussing this fuzz tester. You can get it from:
  https://files.nickj.org/MediaWiki/Fuzz-Testing-MediaWiki-xvid.avi
...
Options:
  ...
  --base-url              : URL to a wiki on which to run the tests. 
                            The "https://" is optional and can be omitted.
...
define("VALIDATOR_URL",  "https://validator.w3.org/check");
...
class wikiFuzz {
    ...
    static private $ints  = array(
            ...
            // a "lignature" - https://www.robinlionheart.com/stds/html4/spchars#ligature
            "&zwnj;"
                );
    ...
    static private $ext = array(
            ...
            // Some XSS attack vectors from https://ha.ckers.org/xss.html 
            "&#x09;", // tab
            "&#x0A;", // newline
            "&#x0D;", // carriage return
            "\0",     // null character
            ...
            "https://debian.org/Pics/debian.png",
...
function getAsURL(pageTest $test) {
    ...
    $retval = "https://get-to-post.nickj.org/?" . WIKI_BASE_URL . $test->getPagePath();
...
function runWikiTest(pageTest $test, &$testname, $can_overwrite = false) {
    ...
    if (       strpos($wiki_preview, "<b>Warning</b>: "        ) !== false 
        ...
        // Avoid probable PHP bug with bad session ids; https://bugs.php.net/bug.php?id=38224 
