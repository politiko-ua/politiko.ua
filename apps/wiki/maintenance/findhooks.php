 ...
 * @license https://www.gnu.org/copyleft/gpl.html GNU General Public Licence 2.0 or later
 */
...
function getHooksFromDoc() {
	...
	if( isset( $options['online'] ) ){
		$content = Http::get( 'https://www.mediawiki.org/w/index.php?title=Manual:Hooks&action=raw' );
