...
<ul>
	<li>
		...
		<a href="https://lists.wikimedia.org/mailman/listinfo/mediawiki-announce">low-traffic
...
if( wfIniGetBool( "register_globals" ) ) {
	...
	<li>
		...
		<strong>PHP's <tt><a href="https://php.net/register_globals">register_globals</a></tt> option is enabled. Disable it if you can.</strong>
		</div>
...
if( wfIniGetBool( "magic_quotes_runtime" ) ) {
	$fatal = true;
	?><li class='error'><strong>Fatal: <a href='https://www.php.net/manual/en/ref.info.php#ini.magic-quotes-runtime'>magic_quotes_runtime</a> is active!</strong>
...
if( wfIniGetBool( "magic_quotes_sybase" ) ) {
	$fatal = true;
	?><li class='error'><strong>Fatal: <a href='https://www.php.net/manual/en/ref.sybase.php#ini.magic-quotes-sybase'>magic_quotes_sybase</a> is active!</strong>
	This option corrupts data input unpredictably; you cannot install or use
	MediaWiki unless this option is disabled.</li>
	<?php
}
...
if( wfIniGetBool( "mbstring.func_overload" ) ) {
	$fatal = true;
	?><li class='error'><strong>Fatal: <a href='https://www.php.net/manual/en/ref.mbstring.php#mbstring.overload'>mbstring.func_overload</a> is active!</strong>
...
if( wfIniGetBool( "zend.ze1_compatibility_mode" ) ) {
	$fatal = true;
	?><li class="error"><strong>Fatal: <a href="https://www.php.net/manual/en/ini.core.php">zend.ze1_compatibility_mode</a> is active!</strong>
...
if( wfIniGetBool( "safe_mode" ) ) {
	...
	<a href='https://www.php.net/features.safe-mode'>safe mode</a> is active.</strong>
...
if ( $conf->turck ) {
	print "<li><a href=\"https://turck-mmcache.sourceforge.net/\">Turck MMCache</a> installed</li>\n";
}

$conf->xcache = function_exists( 'xcache_get' );
if( $conf->xcache )
	print "<li><a href=\"https://trac.lighttpd.net/xcache/\">XCache</a> installed</li>\n";

$conf->apc = function_exists('apc_fetch');
if ($conf->apc ) {
	print "<li><a href=\"https://www.php.net/apc\">APC</a> installed</li>\n";
}

$conf->eaccel = function_exists( 'eaccelerator_get' );
if ( $conf->eaccel ) {
	$conf->turck = 'eaccelerator';
	print "<li><a href=\"https://eaccelerator.sourceforge.net/\">eAccelerator</a> installed</li>\n";
}

$conf->dba = function_exists( 'dba_open' );

if( !( $conf->turck || $conf->eaccel || $conf->apc || $conf->xcache ) ) {
	echo( '<li>Couldn\'t find <a href="https://turck-mmcache.sourceforge.net">Turck MMCache</a>,
		<a href="https://eaccelerator.sourceforge.net">eAccelerator</a>,
		<a href="https://www.php.net/apc">APC</a> or <a href="https://trac.lighttpd.net/xcache/">XCache</a>;
...
if( $conf->License == "gfdl1_2" ) {
	$conf->RightsUrl = "https://www.gnu.org/licenses/old-licenses/fdl-1.2.txt";
	...
	$conf->RightsUrl = "https://www.gnu.org/copyleft/fdl.html";
	...
	$conf->RightsUrl = "https://creativecommons.org/licenses/publicdomain/";
		...
		if( $conf->DBtype == 'mysql' ) {
			...
			if( $mysqlOldClient ) {
				print "<li><b>PHP is linked with old MySQL client libraries. If you are
					...
					see <a href='https://dev.mysql.com/doc/mysql/en/old-client.html'
			 		>https://dev.mysql.com/doc/mysql/en/old-client.html</a> for help.</b></li>\n";
			}
		...
		if ($conf->DBtype == 'mysql') {
			...
			if( $mysqlNewAuth && $mysqlOldClient ) {
				print "; <b class='error'>You are using MySQL 4.1 server, but PHP is linked
					...
					<a href='https://dev.mysql.com/doc/mysql/en/old-client.html'
					>https://dev.mysql.com/doc/mysql/en/old-client.html</a> for help.</b>";
			}
			if( $wgDBmysql5 ) {
				if( $mysqlNewAuth ) {
				...
				if ( $conf->Root ) {
					...
					if ( $conn->isOpen() ) {
						...
						if( $mysqlOldClient && $mysqlNewAuth ) {
							print " <b class='error'>If the next step fails, see <a href='https://dev.mysql.com/doc/mysql/en/old-client.html'>https://dev.mysql.com/doc/mysql/en/old-client.html</a> for help.</b>";
						}
						print "</li>\n";
...
<div class="config-section">
   ...
   $script = defined('MW_INSTALL_PHP5_EXT') ? 'index.php5' : 'index.php';
			...
			$ccApp = htmlspecialchars( "https://creativecommons.org/license/?partner=$partner&exit_url=$exit&partner_icon_url=$icon" );
...
?>
	...
	<p>This program is free software; you can redistribute it and/or modify
	 ...
	 or <a href="https://www.gnu.org/copyleft/gpl.html">read it online</a></p>
	</div>
...
<div id="column-one">
	...
	<div class='portlet'><div class='pBody'>
		<ul>
			<li><strong><a href="https://www.mediawiki.org/">MediaWiki home</a></strong></li>
			<li><a href="../README">Readme</a></li>
			<li><a href="../RELEASE-NOTES">Release notes</a></li>
			<li><a href="../docs/">Documentation</a></li>
			<li><a href="https://www.mediawiki.org/wiki/Help:Contents">User's Guide</a></li>
			<li><a href="https://www.mediawiki.org/wiki/Manual:Contents">Administrator's Guide</a></li>
			<li><a href="https://www.mediawiki.org/wiki/Manual:FAQ">FAQ</a></li>
		</ul>
