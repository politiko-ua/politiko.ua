...
class SpecialVersion extends SpecialPage {
	...
	static function MediaWikiCredits() {
		...
		"__NOTOC__
		This wiki is powered by '''[https://www.mediawiki.org/ MediaWiki]''',
		...
		or [https://www.gnu.org/licenses/old-licenses/gpl-2.0.html read it online].
		";
	...
	static function softwareInformation() {
		...
		return Xml::element( 'h2', array( 'id' => 'mw-version-software' ), wfMsg( 'version-software' ) ) .
			Xml::openElement( 'table', array( 'id' => 'sv-software' ) ) .
				...
				<tr>
					<td>[https://www.mediawiki.org/ MediaWiki]</td>
					<td>" . self::getVersionLinked() . "</td>
				</tr>\n
				<tr>
					<td>[https://www.php.net/ PHP]</td>
	...
	public static function getVersionLinked() {
		...
		wfProfileIn( __METHOD__ );
		$svn = self::getSvnRevision( $IP );
		$viewvc = 'https://svn.wikimedia.org/viewvc/mediawiki/trunk/phase3/?pathrev=';
	...
	public static function getSvnRevision( $dir ) {
		// https://svnbook.red-bean.com/nightly/en/svn.developer.insidewc.html
