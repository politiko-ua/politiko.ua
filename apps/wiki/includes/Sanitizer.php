...
class Sanitizer {
	 ...
	 *                                                          in the id and
	 *                                                          name attributes
	 * @see https://www.w3.org/TR/html401/struct/links.html#h-12.2.3 Anchors with the id attribute
	 *
	...
	static function escapeId( $id, $options = array() ) {
		...
		# 5th edition, NameStartChar and NameChar: <https://www.w3.org/TR/REC-xml/>
	 ...
	 *
	 * See https://www.w3.org/TR/REC-xml/#AVNormalize for background,
