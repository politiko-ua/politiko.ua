	...
	protected function getKnownLicenses() {
		...
		foreach ($ccVersions as $version) {
			foreach ($ccLicenses as $license) {
				...
				$lurl = "https://creativecommons.org/licenses/{$license}/{$version}/";
		...
		$knownLicenses['https://creativecommons.org/licenses/GPL/2.0/'] =
		  array('de', 're', 'di', 'no', 'sa', 'sc');
		$knownLicenses['https://creativecommons.org/licenses/LGPL/2.1/'] =
		  array('de', 're', 'di', 'no', 'sa', 'sc');
		$knownLicenses['https://www.gnu.org/copyleft/fdl.html'] =
		  array('de', 're', 'di', 'no', 'sa', 'sc');
...
<!DOCTYPE rdf:RDF PUBLIC "-//DUBLIN CORE//DCMES DTD 2002/07/31//EN" "https://dublincore.org/documents/2002/07/31/dcmes-xml/dcmes-xml-dtd.dtd">
...
PROLOGUE;
	...
	protected function term( $term, $name ){
		print "\t\t<cc:{$term} rdf:resource=\"https://web.resource.org/cc/{$name}\" />\n";
	}
