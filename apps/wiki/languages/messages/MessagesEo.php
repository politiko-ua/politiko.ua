...
'mainpagedocfooter' => "Konsultu la [https://meta.wikimedia.org/wiki/MediaWiki_User%27s_Guide User's Guide] por informo pri uzado de vikia programaro.

==Kiel komenci==

* [https://www.mediawiki.org/wiki/Manual:Configuration_settings Listo de konfiguraĵoj] (angla)
* [https://www.mediawiki.org/wiki/Manual:FAQ MediaWiki Oftaj Demandoj] (angla)
* [https://lists.wikipedia.org/mailman/listinfo/mediawiki-announce MediaWiki dissendolisto pri anoncoj] (angla)",
...
'editinginterface'     => "'''Atentu:''' Vi redaktas paĝon, kiu estas uzata kiel interfaca teksto por la softvaro. Ŝanĝoj de tiu ĉi teksto povas ŝanĝi aspekton de la interfaco por aliaj uzantoj. Por tradukojn, bonvolu uzi [https://translatewiki.net/wiki/Main_Page?setlang=eo translatewiki.net], la projekto por fari lokajn versiojn de MediaWiki.",
...
'extlink_sample'  => 'https://www.example.com ligtitolo',
'extlink_tip'     => 'Ekstera ligo (memoru https:// prefikson)',
...
'upload-proto-error-text' => 'Fora alŝuto devas URL-on komence de <code>https://</code> aŭ <code>ftp://</code>.',
...
'statistics-jobqueue'          => 'Longeco de [https://www.mediawiki.org/wiki/Manual:Job_queue vico de prokrastita reenkategoriado]',
...
'exif-exposureprogram-3' => 'Diafragma prioritato <!-- vidu https://www.fw.hu/eventoj/steb/vortaroj/fotografio/fotografio.htm -->',
