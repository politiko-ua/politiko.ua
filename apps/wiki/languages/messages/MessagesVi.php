...
* [https://www.mediawiki.org/wiki/Manual:Configuration_settings Danh sách các thiết lập cấu hình]
* [https://www.mediawiki.org/wiki/Manual:FAQ Các câu hỏi thường gặp MediaWiki]
...
'editinginterface'     => "'''Lưu ý:''' Bạn đang sửa chữa một trang dùng để cung cấp thông báo giao diện cho phần mềm. Những thay đổi tại trang này sẽ ảnh hưởng đến giao diện của rất nhiều người dùng website này. Để dịch luật, hãy xem xét việc sử dụng [https://translatewiki.net/wiki/Main_Page?setlang=vi translatewiki.net], dự án địa phương hóa của MediaWiki.",
...
'link_tip'        => 'Liên kết',
'extlink_sample'  => 'https://www.example.com liên kết ngoài',
'extlink_tip'     => 'Liên kết ngoài (nhớ ghi https://)',
...
'upload-proto-error-text' => 'Phải đưa vào URL bắt đầu với <code>https://</code> hay <code>ftp://</code> để tải lên tập tin từ trang web khác.',
...
'statistics-jobqueue'          => 'Chiều dài [https://www.mediawiki.org/wiki/Manual:Job_queue hàng đợi việc]',
...
Mời vào [https://www.mediawiki.org/wiki/Localisation Địa phương hóa MediaWiki]  và [https://translatewiki.net translatewiki.net] nếu bạn muốn đóng góp dịch chung cả MediaWiki.',
