...
== Yeni Başlayanlar ==
* [https://www.mediawiki.org/wiki/Manual:Configuration_settings Yapılandırma ayarlarının listesi]
* [https://www.mediawiki.org/wiki/Manual:FAQ MediaWiki SSS]
...
'editinginterface'     => "'''UYARI:''' Yazılım için arayüz sağlamakta kullanılan bir sayfayı değiştirmektesiniz. Bu sayfadaki değişiklikler kullanıcı arayüzünü diğer kullanıcılar için de değiştirecektir. Çeviriler için, lütfen [https://translatewiki.net/wiki/Main_Page?setlang=tr translatewiki.net]'yi kullanarak MediaWiki yerelleştirme projesini dikkate alınız.",
...
'extlink_sample'  => 'https://www.example.com adres açıklaması',
'extlink_tip'     => 'Dış bağlantı (Adresin önüne https:// koymayı unutmayın)',
...
'upload-proto-error-text' => "Uzaktan yükleme, <code>https://</code> veya <code>ftp://</code> ile başlayan URL'ler gerektirmektedir.",
...
'statistics-jobqueue'          => '[https://www.mediawiki.org/wiki/Manual:Job_queue İş sırası] uzunluğu',
