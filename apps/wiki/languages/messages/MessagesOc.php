...
'mainpagedocfooter' => "Consultatz lo [https://meta.wikimedia.org/wiki/Ajuda:Contengut Guida de l'utilizaire] per mai d'entresenhas sus l'utilizacion d'aqueste logicial.

== Començar amb MediaWiki ==

* [https://www.mediawiki.org/wiki/Manual:Configuration_settings Lista dels paramètres de configuracion]
...
'extlink_sample'  => 'https://www.example.com títol del ligam',
'extlink_tip'     => 'Ligam extèrn (doblidez pas lo prefix https://)',
...
'upload-proto-error-text' => "L’impòrt requerís d'URLs començant per <code>https://</code> o <code>ftp://</code>.",
...
'statistics-jobqueue'          => 'Longor de la [https://www.mediawiki.org/wiki/Manual:Job_queue lista d’espèra de tractament]',
...
Visitatz la [https://www.mediawiki.org/wiki/Localisation Localizacion MèdiaWiki] e [https://translatewiki.net translatewiki.net] se desiratz contribuir a la localizacion MèdiaWiki generica.',
