...
* [https://www.mediawiki.org/wiki/Manual:Configuration_settings لستة اعدادات الضبط]
* [https://www.mediawiki.org/wiki/Manual:FAQ أسئلة بتكرر حوالين الميدياويكى]
...
'editinginterface'     => "'''تحذير''': أنت بتعدل صفحة بتستخدم فى الواجهة النصية  بتاعة البرنامج. التغييرات فى الصفحة دى ها تأثر على مظهر واجهة اليوزر لليوزرز التانيين. للترجمات، لو سمحت استخدم [https://translatewiki.net/wiki/Main_Page?setlang=ar بيتاويكي]، مشروع ترجمة الميدياويكى.",
...
'extlink_sample'  => 'https://www.example.com عنوان الوصله',
'extlink_tip'     => 'وصله خارجيه (افتكر تحط https:// قبل عنوان الوصله)',
...
'upload-proto-error-text' => 'االتحميل عن بعد لازمله يوأرإل بيبتدى بـ <code>https://</code> أو <code>ftp://</code>.',
...
'statistics-jobqueue'          => 'طول [https://www.mediawiki.org/wiki/Manual:Job_queue طابور الشغل]',
...
لو سمحت تزور[https://www.mediawiki.org/wiki/Localisation ترجمة ميدياويكي] و [https://translatewiki.net بيتاويكي] لو كنت عايز تساهم فى ترجمة ميدياويكى الاصلية.',
