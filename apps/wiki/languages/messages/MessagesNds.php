...
$bookstoreList = array(
	'Verteken vun leverbore Böker'  => 'https://www.buchhandel.de/sixcms/list.php?page=buchhandel_profisuche_frameset&suchfeld=isbn&suchwert=$1=0&y=0',
...
Wenn du Text översetten wist, de betherto noch gornich översett is, denn maak dat opbest op [https://translatewiki.net/wiki/Main_Page?setlang=nds translatewiki.net], dat Översett-Projekt vun MediaWiki.",
...
'extlink_tip'     => 'Externen Link (https:// is wichtig)',
...
'upload-proto-error-text' => 'De URL mutt mit <code>https://</code> oder <code>ftp://</code> anfangen.',
...
'statistics-jobqueue'          => '[https://www.mediawiki.org/wiki/Manual:Job_queue Job-Queue-Längd]',
