 ...
 */
$bookstoreList = array(
	'Národní knihovna'          => 'https://sigma.nkp.cz/F/?func=find-a&find_code=ISN&request=$1',
	'Státní technická knihovna' => 'https://www.stk.cz/cgi-bin/dflex/CZE/STK/BROWSE?A=01&V=$1',
	'inherit' => true,
);
...
'mainpagedocfooter' => '[https://meta.wikimedia.org/wiki/Help:Contents Uživatelská příručka] vám napoví, jak MediaWiki používat.

== Začínáme ==

* [https://www.mediawiki.org/wiki/Manual:Configuration_settings Nastavení konfigurace]
* [https://www.mediawiki.org/wiki/Manual:FAQ Často kladené otázky o MediaWiki]
...
'editinginterface'     => "'''Upozornění:''' Editujete stránku, která definuje texty rozhraní. Změny této stránky ovlivní vzhled uživatelského rozhraní všem uživatelům. Při úpravách českého překladu zvažte použití [https://translatewiki.net/wiki/Main_Page?setlang=cs Betawiki], projektu pro lokalizaci MediaWiki.",
...
'extlink_sample'  => 'https://www.example.com Titulek odkazu',
'extlink_tip'     => 'Externí odkaz (nezapomeňte na předponu https://)',
...
'upload-proto-error-text' => 'Nahrání vzdáleného souboru vyžaduje zadání URLs začínající na <code>https://</code> nebo <code>ftp://</code>.',
...
'statistics-jobqueue'          => 'Délka [https://www.mediawiki.org/wiki/Manual:Job_queue fronty údržby]',
