...
See https://test.wikipedia.org/wiki/Category:Test_ko?uselang={{SUBPAGENAME}}, for example.',
...
{{Identical|Talk}}',
'personaltools' => 'Heading for a group of links to your user page, talk page, preferences, watchlist, and contributions. This heading is visible in the sidebar in some skins. For an example, see [https://translatewiki.net/wiki/Main_Page?useskin=simple Main Page using simple skin].',
...
'youhavenewmessagesmulti' => 'The alternative of {{msg|youhavenewmessages}} as used on wikis with a special setup so they can receive the "new message" notice on other wikis as well. Used on [https://www.wikia.com/ Wikia].',
...
# [https://translatewiki.net/w/i.php?title=Betawiki:News&oldid=9999999 Permalink with invalid revision#]
# [https://translatewiki.net/w/i.php?title=Betawiki:News&diff=426850&oldid=99999999 Diff with invalid revision#]
...
[https://translatewiki.net/w/i.php?title=Translating:Tasks&oldid=371789000 Click here] to see an example of such an error message.',
...
[https://translatewiki.net/w/i.php?title=Translating:Tasks&diff=372398&oldid=371789000 Click here] to see an example of such an error message.',
...
'editinginterface' => "A message shown when editing pages in the namespace MediaWiki:. In the [https://translatewiki.net/wiki/Main_Page?setlang=en URL], '''change \"setlang=en\" to your own language code.'''",
...
* $4 is a URL. Example: https://wiki.example.com',
'noemail' => 'Shown as error message when trying to register a user sending password to e-mail adress and no e-mail address has been given. Registering users and sending a password to an e-mail address may require non-standard user rights. ([https://translatewiki.net/w/i.php?title=Special:UserLogin&action=submitlogin&type=signup Register user link])',
...
Parameter $1 is the content of section parameter in the URL (for example 1234 in the URL https://translatewiki.net/w/i.php?title=Sandbox&action=edit&section=1234)',
...
'deleted-notice' => 'Shown on top of a deleted page in normal view modus ([https://translatewiki.net/wiki/Test example]).',
...
'currentrev-asof' => 'The text appears at the right side when comparing 2 different edits of the same page. For example: [https://translatewiki.net/w/i.php?title=FreeCol%3AIntegerAboveZero%2Fca&diff=788645&oldid=788644]',
...
'logdelete-log-message' => 'This log message appears in brackets after the message {{msg|logdelete-logentry}} in the deletion or suppression logs when changing the visibility of a log entry for events. For a brief description of the process of changing the visibility of events and their log entries see this [https://www.mediawiki.org/wiki/RevisionDelete mediawiki explanation]. 
...
'sharedupload' => 'Shown on an image description page when it is used in a central repository (i.e. [https://commons.wikimedia.org/ Commons] for Wikimedia wikis).
...
'protectedtitlestext' => 'Shown on top of list of titles on [[Special:ProtectedTitles]]. If the list is empty the message [[MediaWiki:Protectedtitlesempty]] appears instead of this. See the [https://www.mediawiki.org/wiki/Project:Protected_titles help page on Mediawiki] for more information.',
'protectedtitlesempty' => 'Used on [[Special:ProtectedTitles]]. This text appears if the list of protected titles is empty. See the [https://www.mediawiki.org/wiki/Project:Protected_titles help page on Mediawiki] for more information.',
...
{{Identical|Other time}}',
'protect-existing-expiry' => 'Shows the existing expiry time in the drop down menu of the protection form ([https://translatewiki.net/w/i.php?title=User:Raymond/test&action=unprotect example])
...
{{Identical|Infinite}}",
'restriction-type' => 'Used on [[Special:ProtectedPages]]. The text next to a drop-down box. See the help page on [https://meta.wikimedia.org/wiki/Protect Meta] for more information on protection.',
'restriction-level' => 'Used on [[Special:ProtectedPages]] and [[Special:ProtectedTitles]]. The text next to a drop-down box. See the [https://www.mediawiki.org/wiki/Project:Protected_titles help page on Mediawiki] and on [https://meta.wikimedia.org/wiki/Protect Meta] for more information.',
...
'pagesize' => 'Used on [[Special:ProtectedPages]]. See the help page on [https://meta.wikimedia.org/wiki/Protect Meta] for more information on protection.',
...
{{Identical|Move}}",
'restriction-create' => 'Used on [[Special:ProtectedPages]]. An option in a drop-down box. See the help pages on [https://www.mediawiki.org/wiki/Project:Protected_titles MediaWiki] and [https://meta.wikimedia.org/wiki/Protect Meta] for more information on protection.

{{Identical|Create}}',

# Restriction levels
'restriction-level-sysop' => "Used on [[Special:ProtectedPages]] and [[Special:ProtectedTitles]]. An option in the drop-down box 'Restriction level'. See the [https://www.mediawiki.org/wiki/Project:Protected_titles help page on Mediawiki] and on [https://meta.wikimedia.org/wiki/Protect Meta] for more information.",
'restriction-level-autoconfirmed' => "Used on [[Special:ProtectedPages]] and [[Special:ProtectedTitles]]. An option in the drop-down box 'Restriction level'. See the [https://www.mediawiki.org/wiki/Project:Protected_titles help page on Mediawiki] and on [https://meta.wikimedia.org/wiki/Protect Meta] for more information.",
'restriction-level-all' => "Used on [[Special:ProtectedPages]] and [[Special:ProtectedTitles]]. An option in the drop-down box 'Restriction level'. See the [https://www.mediawiki.org/wiki/Project:Protected_titles help page on Mediawiki] and on [https://meta.wikimedia.org/wiki/Protect Meta] for more information.",
...
'exif-exposureprogram-1' => "One of the exposure program types in the table of metadata on image description pages. See the Wikipedia article '[https://en.wikipedia.org/wiki/Mode_dial Mode dial]' for an explanation.",
'exif-exposureprogram-3' => 'One of the exposure program types in the table of metadata on image description pages. See the Wikipedia article for a definition of the term [https://en.wikipedia.org/wiki/Aperture_priority aperture priority].',
'exif-exposureprogram-4' => 'One of the exposure program types in the table of metadata on image description pages. See the Wikipedia article for a definition of the term [https://en.wikipedia.org/wiki/Shutter_priority shutter priority].',
'exif-exposureprogram-5' => "One of the exposure program types in the table of metadata on image description pages. See the Wikipedia article '[https://en.wikipedia.org/wiki/Mode_dial Mode dial]' for an explanation.",
'exif-exposureprogram-6' => "One of the exposure program types in the table of metadata on image description pages. See the Wikipedia article '[https://en.wikipedia.org/wiki/Mode_dial Mode dial]' for an explanation.",
'exif-exposureprogram-7' => "One of the exposure program types in the table of metadata on image description pages. See the Wikipedia article '[https://en.wikipedia.org/wiki/Mode_dial Mode dial]' for an explanation.",
'exif-exposureprogram-8' => "One of the exposure program types in the table of metadata on image description pages. See the Wikipedia article '[https://en.wikipedia.org/wiki/Mode_dial Mode dial]' for an explanation.",
...
Please leave the link https://www.mediawiki.org/wiki/Manual:External_editors exactly as it is.',
