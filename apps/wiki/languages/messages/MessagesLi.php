...
'mainpagedocfooter' => "Raodpleeg de [https://meta.wikimedia.org/wiki/NL_Help:Inhoudsopgave handjleiding] veur informatie euver 't gebroek van de wikisoftware.

== Mieë hölp ==

* [https://www.mediawiki.org/wiki/Manual:Configuration_settings Lies mit instellinge]
* [https://www.mediawiki.org/wiki/Manual:FAQ MediaWiki VGV (FAQ)]
...
'editinginterface'     => "'''Waarsjoewing:''' Doe bewirks 'n pazjena die gebroek waert door de software. Bewirkinge op dees pazjena beïnvlode de gebroekersinterface van ederein. Euverwaeg veur vertalinge óm [https://translatewiki.net/wiki/Main_Page?setlang=nl translatewiki.net] te gebroeke, 't vertalingsprojek veur MediaWiki.",
...
'extlink_tip'     => 'Extern link (mit de https:// prefix)',
...
'upload-proto-error-text' => "Uploads via deze methode vereise URL's die beginne met <code>https://</code> of <code>ftp://</code>.",
