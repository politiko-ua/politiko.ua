...
'mainpagedocfooter' => 'Consultă [https://meta.wikimedia.org/wiki/Help:Contents Ghidul utilizatorului (en)] pentru informaţii despre utilizarea programului wiki.

== Primii paşi ==
* [https://www.mediawiki.org/wiki/Manual:Configuration_settings Lista parametrilor configurabili (en)]
* [https://www.mediawiki.org/wiki/Manual:FAQ Întrebări frecvente despre MediaWiki (en)]
...
'editinginterface'     => "'''Avertizare''': Editezi o pagină care este folosită pentru a furniza textul interfeţei pentru software. Modificările aduse acestei pagini vor afecta aspectul interfeţei utilizatorului pentru alţi utilizatori. Pentru traduceri, consideraţi utilizarea [https://translatewiki.net/wiki/Main_Page?setlang=en translatewiki.net], proiectul MediaWiki de localizare.",
...
'extlink_sample'  => 'https://www.example.com titlul legăturii',
'extlink_tip'     => 'Legătură externă (nu uitaţi prefixul https://)',
...
'upload-proto-error-text' => 'Importul de la distanţă necesită adrese URL care încep cu <code>https://</code> sau <code>ftp://</code>.',
...
Lista tipurilor MIME recunoscute de MediaWiki poate fi găsită la [https://svn.wikimedia.org/viewvc/mediawiki/trunk/phase3/includes/mime.types?view=markup fişiere mime.types].',
'mimetype'           => 'Tip MIME:',
'download'           => 'descarcă',
...
Vă rugăm să vizitaţi [https://www.mediawiki.org/wiki/Localisation MediaWiki Localisation] şi [https://translatewiki.net translatewiki.net] dacă vreţi să contribuiţi la localizarea programului MediaWiki generic.',
...
'edit-externally-help' => '(Vedeţi [https://www.mediawiki.org/wiki/Manual:External_editors instrucţiuni de instalare] pentru mai multe informaţii)',
