...
'mainpagedocfooter' => 'Інформацію про роботу з цією вікі можна знайти в [https://meta.wikimedia.org/wiki/%D0%9F%D0%BE%D0%BC%D0%BE%D1%89%D1%8C:%D0%A1%D0%BE%D0%B4%D0%B5%D1%80%D0%B6%D0%B0%D0%BD%D0%B8%D0%B5 посібнику користувача].

== Деякі корисні ресурси ==
* [https://www.mediawiki.org/wiki/Manual:Configuration_settings Список налаштувань];
* [https://www.mediawiki.org/wiki/Manual:FAQ Часті питання з приводу MediaWiki];
...
'extlink_sample'  => 'https://www.example.com назва посилання',
'extlink_tip'     => 'Зовнішнє посилання (не забудьте про префікс https://)',
...
'upload-proto-error-text' => 'Віддалене завантаження вимагає адресів, що починаються з <code>https://</code> або <code>ftp://</code>.',
...
'statistics-jobqueue'          => 'Величина [https://www.mediawiki.org/wiki/Manual:Job_queue черги завдань]',
...
Будь ласка, відвідайте [https://www.mediawiki.org/wiki/Localisation MediaWiki Localisation] і [https://translatewiki.net translatewiki.net], якщо ви хочете зробити внесок до спільної локалізації MediaWiki.',
