...
== باستاۋ ٴۇشىن ==
* [https://www.mediawiki.org/wiki/Manual:Configuration_settings باپتالىم قالاۋلارىنىڭ ٴتىزىمى]
* [https://www.mediawiki.org/wiki/Manual:FAQ مەدىياۋىيكىيدىڭ جىيى قويىلعان ساۋالدارى]
...
اۋدارمالار ٴۇشىن, MediaWiki باعدارلاماسىن جەرسىندىرۋ [https://translatewiki.net/wiki/Main_Page?setlang=kk translatewiki.net جوباسى] ارقىلى قاراپ شەشىڭىز.",
...
'extlink_sample'  => 'https://www.example.com سىلتەمە تاقىرىبىن اتى',
'extlink_tip'     => 'شەتتىك سىلتەمە (الدىنان https:// ەنگىزۋىن ۇمىتپاڭىز)',
...
'upload-proto-error-text' => 'شەتتەن قوتارىپ بەرۋ ٴۇشىن URL جايلارى <code>https://</code> نەمەسە <code>ftp://</code> دەگەندەردەن باستالۋ ٴجون.',
...
ەگەر امبەباپ MediaWiki جەرسىندىرۋگە ۇلەس قوسقىڭىز كەلسە [https://www.mediawiki.org/wiki/Localisation MediaWiki جەرسىندىرۋ بەتىنە] جانە [https://translatewiki.net translatewiki.net جوباسىنا] بارىپ شىعىڭىز.',
