...
'mainpagedocfooter' => "Konsulta ma' [https://meta.wikimedia.org/wiki/Help:Contents User's Guide] għal informazzjoni dwar kif tuża software tal-wiki.

== Biex tibda ==
* [https://www.mediawiki.org/wiki/Manual:Configuration_settings Lista ta' preferenzi għal konfigurazzjoni]
* [https://www.mediawiki.org/wiki/Manual:FAQ FAQ ta'MedjaWiki]
...
'editinginterface'     => "'''Avviż:''' Qiegħed tagħmel modifiki lejn paġna li qegħdha tintuża biex tipprovdi interfaċċa għall-messaġġi tas-software. Kull modifika f'din il-paġna se taffetwa l-apparenza tal-faċċata tal-utenti kollha. Għat-traduzzjonijiet, ikkunsidra l-possibilità li tuża'  [https://translatewiki.net/wiki/Main_Page?setlang=mt translatewiki.net], il-proġett MediaWiki għal-lokalizzazzjoni.",
...
'extlink_sample'  => 'https://www.example.com titlu tal-link',
'extlink_tip'     => 'Link estern (ftakar il-prefiss https://)',
...
'upload-proto-error-text' => "Għal upload remote huwa neċessarju tispeċifika l-URL li jibda' b'<code>https://</code> jew <code>ftp://</code>.",
