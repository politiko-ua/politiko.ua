...
'editinginterface'     => "'''Obacht:''' Du bisch e Syten am Verändere, wu zum User.Interface ghert. Wänn Du die Syte veränderesch, no änderet sich s User-Interface au fir di andere Benutzer. Fir Ibersetzige lueg bitte, eb Du doodefir s [https://translatewiki.net/wiki/Main_Page?setlang=gsw Translatewiki] witt bruuche, s MediaWiki-Lokalisierigsprojäkt.",
...
'extlink_sample'  => 'https://www.example.com Linktekscht',
'extlink_tip'     => 'Externer Link (https:// beachte)',
...
'upload-proto-error-text' => 'D URL muess mit <code>https://</code> oder <code>ftp://</code> aafange.',
...
'statistics-jobqueue'          => 'Längi vu dr [https://www.mediawiki.org/wiki/Manual:Job_queue Uftragswarteschlang]',
...
'blockiptext'                     => 'Bnutz des Formular, zum e Bnutzer oder e IP-Adress z\'blockiere.<sup class="plainlinks">[https://jodies.de/ipcalc?host=&mask1=&mask2= <span title="IP-Berych ermittle; bloss kurz sperre!">(B)</span>]</sup>
...
Lueg au uf [https://www.mediawiki.org/wiki/Localisation MediaWiki Lokalisierig] un [https://translatewiki.net translatewiki.net], wänn Du zue dr MediaWiki-Lokalisierig wit byytrage.',
