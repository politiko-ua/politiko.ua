...
'mainpagedocfooter' => 'Молимо видите [https://meta.wikimedia.org/wiki/Help:Contents кориснички водич] за информације о употреби вики софтвера.

== За почетак ==
* [https://www.mediawiki.org/wiki/Manual:Configuration_settings Помоћ у вези са подешавањима]
* [https://www.mediawiki.org/wiki/Manual:FAQ Најчешће постављена питања]
...
За преводе, посетите [https://translatewiki.net/wiki/Main_Page?setlang=sr_ec translatewiki.net], пројекат локализације МедијаВики софтвера.",
...
'extlink_sample'  => 'https://www.example.com опис адресе',
'extlink_tip'     => 'спољашња веза (не заборавите префикс https://)',
...
'upload-proto-error-text' => 'Слање екстерних фајлова захтева УРЛове који почињу са <code>https://</code> или <code>ftp://</code>.',
...
Посетите [https://translatewiki.net translatewiki.net] уколико желите да помогнете у локализацији.',
