...
* [https://www.mediawiki.org/wiki/Manual:Configuration_settings Lîsteya varîyablên konfîgûrasîyonê]
...
'editinginterface'     => "'''Hîşyar:''' Tu rûpelekî diguherînê yê ji wêşandinê înformasyonan di sistêmê da girîn in. Guherandin di vê rûpelê da ji her bikarhêneran ra yê were dîtin. Ji bo tercemekirinan, xêra xwe di [https://translatewiki.net/wiki/Main_Page?setlang=ku translatewiki.net] da bixebite, projeyê MediaWiki.",
...
'extlink_sample'  => 'https://www.example.com navê lînkê',
'extlink_tip'     => 'Lînka derve (https:// di destpêkê de ji bîr neke)',
