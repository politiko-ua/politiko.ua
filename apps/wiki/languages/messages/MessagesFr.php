...
'mainpagedocfooter' => 'Consultez le [https://meta.wikimedia.org/wiki/Aide:Contenu Guide de l’utilisateur] pour plus d’informations sur l’utilisation de ce logiciel.

== Démarrer avec MediaWiki ==

* [https://www.mediawiki.org/wiki/Manual:Configuration_settings Liste des paramètres de configuration]
* [https://www.mediawiki.org/wiki/Manual:FAQ/fr FAQ MediaWiki]
...
'editinginterface'     => "'''Attention :''' vous êtes en train d’éditer une page utilisée pour créer le texte de l’interface du logiciel. Les changements se répercuteront, selon le contexte, sur toutes ou certaines pages visibles par les autres utilisateurs. Pour les traductions, nous vous invitons à utiliser le projet MediaWiki d’internationalisation des messages [https://translatewiki.net/wiki/Main_Page?setlang=fr translatewiki.net].",
...
'extlink_sample'  => 'https://www.example.com titre du lien',
'extlink_tip'     => 'Lien externe (n’oubliez pas le préfixe https://)',
...
'upload-proto-error-text' => 'L’import à distance requiert des URL commençant par <code>https://</code> ou <code>ftp://</code>.',
...
'statistics-jobqueue'          => 'Longueur de la [https://www.mediawiki.org/wiki/Manual:Job_queue liste d’attente de traitement]',
...
Veuillez visiter la [https://www.mediawiki.org/wiki/Localisation Localisation de MediaWiki] et [https://translatewiki.net/ translatewiki.net] si vous désirez contribuer à la localisation générique de MediaWiki.',
