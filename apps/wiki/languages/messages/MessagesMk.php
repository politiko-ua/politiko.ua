...
'mainpagedocfooter' => 'Погледнете го [https://meta.wikimedia.org/wiki/Help:Contents Корисничкото напатствие] за подетални иформации како се користи вики софтверот.

==Од каде да почнете==
* [https://meta.wikimedia.org/wiki/Manual:Configuration_settings Листа на нагодувања]
* [https://meta.wikimedia.org/wiki/Manual:FAQ MediaWiki ЧПП (често поставувани прашања)].
...
За превод, имајте го во предвид проектот [https://translatewiki.net/wiki/Main_Page?setlang=mk translatewiki.net], MediaWiki проект за локализација.",
...
'extlink_sample'  => 'https://www.example.com наслов на врска',
'extlink_tip'     => 'Надворешна врска (користи https:// префикс)',
...
'upload-proto-error-text' => 'За оддалечено подигнување потребно е URL-то да почнува со <code>https://</code> или <code>ftp://</code>.',
...
'statistics-jobqueue'          => 'Должина на [https://www.mediawiki.org/wiki/Manual:Job_queue редица на чекање]',
...
Ве молиме одете на [https://www.mediawiki.org/wiki/Localisation Локализација на МедијаВики] и [https://translatewiki.net Бетавики] ако сакате да придонесете кон генеричката локализацијата на МедијаВики.',
...
'edit-externally-help' => '(Види [https://www.mediawiki.org/wiki/Manual:External_editors повеќе инстрикции] за нагодување).',
