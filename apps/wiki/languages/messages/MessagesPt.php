...
'mainpagedocfooter' => 'Consulte o [https://meta.wikimedia.org/wiki/Help:Contents Guia de Utilizadores] para informações acerca de como utilizar o software wiki.

== Começando ==

* [https://www.mediawiki.org/wiki/Manual:Configuration_settings Lista de opções de configuração]
* [https://www.mediawiki.org/wiki/Manual:FAQ MediaWiki Perguntas e respostas frequentes]
...
'editinginterface'     => "'''Aviso:''' Encontra-se a editar uma página que é utilizada para fornecer texto de interface ao software. Alterações nesta página irão afectar a aparência da interface de utilizador para outros utilizadores. Para traduções, considere utilizar a [https://translatewiki.net/wiki/Main_Page?setlang=pt translatewiki.net], um projecto destinado à tradução do MediaWiki.",
...
'extlink_sample'  => 'https://www.example.com ligação externa',
'extlink_tip'     => 'Ligação externa (lembre-se do prefixo https://)',
...
'upload-proto-error-text' => 'O envio de ficheiros remotos requer endereços (URLs) que iniciem com <code>https://</code> ou <code>ftp://</code>.',
...
'statistics-jobqueue'          => 'Tamanho da [https://www.mediawiki.org/wiki/Manual:Job_queue fila de tarefas]',
...
Acesse [https://www.mediawiki.org/wiki/Localisation MediaWiki Localisation] e [https://translatewiki.net translatewiki.net] caso deseje contribuir para traduções do MediaWiki feitas para uso geral.',
