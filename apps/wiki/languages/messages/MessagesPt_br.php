...
* [https://www.mediawiki.org/wiki/Manual:FAQ FAQ do MediaWiki]
...
'editinginterface'     => "'''Aviso:''' Você se encontra prestes a editar uma página que é utilizada para fornecer texto de interface ao software. Alterações nesta página irão afetar a aparência da interface de usuário para outros usuários. Para traduções, considere utilizar a [https://translatewiki.net/wiki/Main_Page?setlang=pt-br translatewiki.net], um projeto destinado para a tradução do MediaWiki.",
...
'extlink_tip'     => 'Link externo (lembre-se do prefixo https://)',
...
'upload-proto-error-text' => 'O envio de arquivos remotos requer endereços (URLs) que iniciem com <code>https://</code> ou <code>ftp://</code>.',
