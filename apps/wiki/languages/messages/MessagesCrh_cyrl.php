...
* [https://www.mediawiki.org/wiki/Manual:Configuration_settings Олуджы сазламалар джедвели];
* [https://www.mediawiki.org/wiki/Manual:FAQ MediaWiki боюнджа сыкъ берильген суаллернен джеваплар];
...
'editinginterface'     => "'''Тенби''': MediaWiki система беянатылы бир саифени денъиштирмектесинъиз. Бу саифедеки денъишикликлер къулланыджы интерфейс корюнишини дигер къулланыджылар ичюн де денъиштиреджек. Лютфен, терджимелер ичюн [https://translatewiki.net/wiki/Main_Page?setlang=crh translatewiki.net] сайтыны (MediaWiki ресмий локализация проекти) къулланынъыз.",
...
'extlink_sample'  => 'https://www.example.com саифенинъ серлевасы',
'extlink_tip'     => 'Тыш багъланты (Адрес огюне https:// къоймагъа унутманъыз)',
...
'upload-proto-error-text' => 'Интернеттен бир ресим файлы юклемеге истесенъиз адрес <code>https://</code> я да <code>ftp://</code>нен башламалы.',
...
MediaWiki интерфейсининъ чешит тиллерге терджиме этювде иштирак этмеге истесенъиз [https://www.mediawiki.org/wiki/Localisation MediaWiki Localisation] ве [https://translatewiki.net translatewiki.net] саифелерине зиярет этинъиз.',
