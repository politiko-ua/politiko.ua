...
'mainpagedocfooter' => "Kuckt w.e.g. [https://meta.wikimedia.org/wiki/Help:Contents d'Benotzerhandbuch] fir den Interface ze personnaliséieren.

== Starthëllefen ==
* [https://www.mediawiki.org/wiki/Manual:Configuration_settings Hëllef bei der Konfiguratioun]
...
'editinginterface'     => "'''Opgepasst:''' Dir sidd am Gaang, eng Säit z'änneren, déi do ass, fir Interface-Text fir d'Software ze liwweren. Ännerungen op dëser Säit änneren den Interface-Text, je no Kontext, op allen oder verschiddene Säiten, déi vun alle Benotzer gesi ginn. Fir d'Iwwersetzungen z'änneren invitéiere mir iech de [https://translatewiki.net/wiki/Main_Page?setlang=lb Projet translatewiki.net] vun den internationale Messagen ze benotzen.",
...
'extlink_sample'  => 'https://www.example.com Link Titel',
'extlink_tip'     => 'Externe Link (Vergiesst net den https:// Prefix)',
...
'upload-proto-error-text' => "D'URL muss matt <code>https://</code> oder <code>ftp://</code> ufänken.",
...
'statistics-jobqueue'          => 'Längt vun der [https://www.mediawiki.org/wiki/Manual:Job_queue Job queue]',
...
Besicht w.e.g. [https://www.mediawiki.org/wiki/Localisation MediaWiki Localisatioun] a [https://translatewiki.net translatewiki.net] wann Dir wëllt bei de MediaWiki Iwwersetzunge matschaffen.",
