...
'mainpagedocfooter' => "Raedpleeg de [https://meta.wikimedia.org/wiki/ZEA_Ulpe:Inhoudsopgaeve andleidieng] voe informatie over 't gebruuk van de wikisoftware.

== Meer ulpe over MediaWiki ==

* [https://www.mediawiki.org/wiki/Manual:Configuration_settings Lieste mie instelliengen]
* [https://www.mediawiki.org/wiki/Manual:FAQ Veehestelde vraehen (FAQ)]
...
'editinginterface'     => "'''Waerschuwienge:''' Je bewerk een pagina die a gebruukt wor deur de software. Bewerkiengen op deêze pagina beïnvloeden de gebrukersinterface van iedereên. Overweeg voe vertaeliengen om [https://translatewiki.net/wiki/Main_Page?setlang=zea translatewiki.net] te gebruken, 't vertaeliengsproject voe MediaWiki.",
...
'extlink_sample'  => 'https://www.example.com lienktekst',
'extlink_tip'     => 'Externe lienk (verheet https:// nie)',
