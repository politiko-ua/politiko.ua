...
'mainpagedocfooter' => 'വിക്കി സോഫ്റ്റ്‌വെയര്‍ ഉപയോഗിക്കുന്നതിനെ കുറിച്ചുള്ള വിശദാംശങ്ങള്‍ക്ക്  [https://meta.wikimedia.org/wiki/Help:Contents വിക്കി സോഫ്റ്റ്‌വെയര്‍ സഹായി] കാണുക.

== പ്രാരംഭസഹായികള്‍ ==
* [https://www.mediawiki.org/wiki/Manual:Configuration_settings ക്രമീകരണ സജ്ജീകരണങ്ങളുടെ പട്ടിക]
* [https://www.mediawiki.org/wiki/Manual:FAQ മീഡിയാവിക്കി പതിവുചോദ്യങ്ങള്‍]
...
'editinginterface'     => "'''മുന്നറിയിപ്പ്:''' വിക്കി സോഫ്റ്റ്‌വെയറില്‍ അത്യാവശ്യമായ ബാഹ്യസന്ദേശങ്ങള്‍ നല്‍കുന്ന ഒരു താളാണു താങ്കള്‍ തിരുത്തുവാന്‍ പോകുന്നത്. ഈ താളില്‍ താങ്കള്‍ വരുത്തുന്ന മാറ്റങ്ങള്‍ ഉപയോക്താവ് വിക്കി കാണുന്ന വിധത്തെ മാറ്റിമറിച്ചേക്കാം. മീഡിയവിക്കി സന്ദേശങ്ങളുടെ പരിഭാഷകള്‍ക്ക് മീഡിയവിക്കി സന്ദേശങ്ങളുടെ പ്രാദേശികവത്കരണ സംരംഭം ആയ [https://translatewiki.net/wiki/Main_Page?setlang=ml ബീറ്റാവിക്കി] ഉപയോഗിക്കുവാന്‍ താല്പര്യപ്പെടുന്നു.",
...
'extlink_sample'  => 'https://www.example.com കണ്ണി തലക്കെട്ട്',
'extlink_tip'     => 'പുറത്തേക്കുള്ള കണ്ണി (https:// എന്ന ഉപസര്‍ഗ്ഗം ചേര്‍ക്കാന്‍ ഓര്‍മ്മിക്കുക)',
...
'upload-proto-error-text' => 'റിമോട്ട് അപ്‌ലോഡിനു <code>https://</code> അല്ലെങ്കില്‍ <code>ftp://</code> യില്‍ തുടങ്ങുന്ന URL വേണം.',
...
'edit-externally-help' => '(കൂടുതല്‍ വിവരത്തിനു https://www.mediawiki.org/wiki/Manual:External_editors കാണുക)',
