...
'mainpagedocfooter' => "Varda ła [https://meta.wikimedia.org/wiki/Aiuto:Sommario Guida utente] (in tałian) par verghe piassè informasion su l'uso de sto software wiki.

== Par scuminsiar ==
I seguenti cołegamenti i xe en lengua inglese:

* [https://www.mediawiki.org/wiki/Manual:Configuration_settings Inpostasion de configurasion]
* [https://www.mediawiki.org/wiki/Manual:FAQ Domande frequenti su MediaWiki]
...
Se te ghè bisogno de tradur in veneto un messagio de l'interfacia utente, te pol doparar [https://translatewiki.net/wiki/Main_Page?setlang=vec translatewiki.net], el progeto de localizazion de MediaWiki.",
...
'extlink_sample'  => 'https://www.example.com titolo del colegamento',
'extlink_tip'     => 'Colegamento esterno (ricòrdete el prefisso https:// )',
...
'upload-proto-error-text' => 'Par el caricamento remoto bisogna specificar URL che scuminsia con <code>https://</code> opure <code>ftp://</code>.',
...
'statistics-jobqueue'          => '[https://www.mediawiki.org/wiki/Manual:Job_queue Cóa dei processi] da far girar in background',
...
'ipb_expiry_invalid'              => 'Tenpo de scadensa mìa valido. Controla el [https://www.gnu.org/software/tar/manual/html_chapter/tar_7.html manual de tar] par la sintassi esatta.',
...
Par piaser visita [https://www.mediawiki.org/wiki/Localisation MediaWiki Localisation] e [https://translatewiki.net translatewiki.net] se te voli jutarne par la traduzion del software MediaWiki ne le varie lengue.",
...
'edit-externally-help' => '(Par savérghene piessè varda le [https://www.mediawiki.org/wiki/Manual:External_editors istruzion])',
