...
'mainpagedocfooter' => "Raodpleeg de [https://meta.wikimedia.org/wiki/Help:Contents haandleiding] veur infermasie over 't gebruuk van de wikipregrammetuur.

== Meer hulpe ==
* [https://www.mediawiki.org/wiki/Help:Configuration_settings Lieste mit instellingen]
* [https://www.mediawiki.org/wiki/Help:FAQ MediaWiki-vragen dee vake esteld wonnen]
* [https://mail.wikimedia.org/mailman/listinfo/mediawiki-announce MediaWiki-poslieste veur nieje versies]",
...
'editinginterface'     => "'''Waorschuwing:''' je bewarken een pagina dee gebruuk wonnen deur de pregrammetuur. Wiezigingen dee an-ebröch wonnen op disse pagina zullen 't uterlijk veur iederene beïnvleujen. Overweeg veur vertalingen um [https://translatewiki.net/wiki/Main_Page?setlang=nds-nl translatewiki.net] te gebruken, 't vertalingsprejek veur MediaWiki.",
...
'extlink_sample'  => 'https://www.example.com linktekst',
...
'upload-proto-error-text' => 'Um op disse meniere bestanden toe te voegen mutten webadressen beginnen mit <code>https://</code> of <code>ftp://</code>.',
...
'statistics-jobqueue'          => '[https://www.mediawiki.org/wiki/Manual:Job_queue Jobqueuelengte]',
...
'edit-externally-help' => '(zie de [https://www.mediawiki.org/wiki/Manual:External_editors instellasie-instructies] veur meer infermasie)',
