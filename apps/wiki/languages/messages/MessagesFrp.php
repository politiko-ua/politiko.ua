...
'mainpagedocfooter' => 'Consultâd lo [https://meta.wikimedia.org/wiki/Aide:Contenu guido d’utilisator] por més d’enformacions sur l’usâjo de la programeria vouiqui.

== Dèmarrar avouéc MediaWiki ==

* [https://www.mediawiki.org/wiki/Manual:Configuration_settings Lista des paramètres de configuracion]
* [https://www.mediawiki.org/wiki/Manual:FAQ/fr FdeQ sur MediaWiki]
...
'editinginterface'     => "'''Atencion :''' vos éte aprés èditar una pâge utilisâ por crèar lo tèxte de l’entèrface de la programeria. Los changements sè cognetront, d’aprés lo contèxte, sur totes ou cèrtênes pâges visibles per los ôtros utilisators. Por les traduccions, nos vos envitens a utilisar lo seto [https://translatewiki.net/wiki/Main_Page?setlang=frp translatewiki.net], lo projèt d’entèrnacionalisacion des mèssâjos de MediaWiki.",
...
'extlink_sample'  => 'https://www.example.com titro du lim',
'extlink_tip'     => 'Lim de defôr (oubliâd pas lo prèfixe https://)',
...
'upload-proto-error-text' => 'L’impôrt requerét des URLs comencient per <code>https://</code> ou ben <code>ftp://</code>.',
...
Please visit [https://www.mediawiki.org/wiki/Localisation MediaWiki Localisation] and [https://translatewiki.net translatewiki.net] if you wish to contribute to the generic MediaWiki localisation.',
...
'edit-externally-help' => 'Vêde les [https://www.mediawiki.org/wiki/Manual:External_editors enstruccions] por més d’enformacions.',
