...
'mainpagedocfooter' => 'Βουλευθήσεσθε τὰς [https://meta.wikimedia.org/wiki/Help:Contents βουλὰς τοῖς Χρωμένοις] ἵνα πληροφορηθῇτε ἐπὶ τοῦ ϝίκι λογισμικοῦ.

== Ἄρξασθε ==
* [https://www.mediawiki.org/wiki/Manual:Configuration_settings Κατάλογος παραμέτρων παρατάξεως]
* [https://www.mediawiki.org/wiki/Manual:FAQ MediaWiki: τὰ πολλάκις αἰτηθέντα]
...
'extlink_sample'  => 'https://www.example.com ὄνομα συνδέσμου',
'extlink_tip'     => 'Ἐξώτερος σύνδεσμος (μέμνησο τὸ πρόθεμα https:// )',
...
'statistics-jobqueue'          => 'Μάκρος [https://www.mediawiki.org/wiki/Manual:Job_queue καταλόγου ἀναμένοντων]',
