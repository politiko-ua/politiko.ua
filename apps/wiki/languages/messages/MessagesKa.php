...
* [https://www.mediawiki.org/wiki/Manual:Configuration_settings კონფიგურაციის მაჩვენებლების სია]
...
'editinginterface'     => "'''ყურადღება:''' თქვენ რედაქტორობთ გვერდს, რომელიც პროგრამის ინტერფეისის ტექსტს შეიცავს. ამ გვერდზე განხორციელებული რედაქტირება გამოიწვევს სხვა მომხმარებელთა სამუშაო ინტერფეისის შეცვლასაც. თარგმანისათვის უმჯობესია გამოიყენოთ [https://translatewiki.net/wiki/Main_Page?setlang=ka translatewiki.net], მედიავიკის ლოკალიზაციის პროექტი.",
...
'link_tip'        => 'შიდა ბმული',
'extlink_sample'  => 'https://www.example.com ბმულის სათაური',
'extlink_tip'     => 'გარე ბმული (გახსოვდეთ https:// პრეფიქსი)',
