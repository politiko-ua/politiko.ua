...
* [https://www.mediawiki.org/wiki/Manual:Configuration_settings Wo nastajenjach]
...
'editinginterface'     => "'''Warnowanje:''' Wobdźěłuješ stronu, kotraž so wužiwa, zo by tekst za softwaru k dispoziciji stajiła. Změny wuskutkuja so na napohlad wužiwarskeho powjercha za druhich wužiwarjow. Hlej za přełožki [https://translatewiki.net/wiki/Main_Page?setlang=en Betawiki], projekt lokalizacije MediaWiki.",
...
'extlink_sample'  => 'https://www.example.com Mjeno wotkaza',
'extlink_tip'     => 'Zwonkowny wotkaz (pomysli sej na prefiks https://)',
...
'upload-proto-error-text' => 'URL dyrbi so z <code>https://</code> abo <code>ftp://</code> započeć.',
...
'statistics-jobqueue'          => 'Dołhosć [https://www.mediawiki.org/wiki/Manual:Job_queue Job queue]',
...
'allmessagestext'           => 'To je lisćina systemowych zdźělenkow, kotrež w mjenowym rumje MediaWiki k dispoziciji steja. Prošu wopytaj [https://www.mediawiki.org/wiki/Localisation lokalizaciju MediaWiki] a [https://translatewiki.net translatewiki.net], jeli chceš k powšitkownej lokalizaciji MediaWiki přinošować.',
