...
'mainpagedocfooter' => "Бу вики турында [https://meta.wikimedia.org/wiki/Ярдәм:Эчтәлек кулланмада] табып була.

== Файдалы ресурслар ==
* [https://www.mediawiki.org/wiki/Manual:Configuration_settings Көйләнмәләр исемлеге];
* [https://www.mediawiki.org/wiki/Manual:FAQ MediaWiki турында еш бирелгән сораулар һәм җаваплар];
...
'editinginterface'     => "'''Игътибар:''' Сез MediaWiki системасы хәбәре беләнге битне үзгәртәсез. Бу башка кулланучылар интерфейсын үзгәртер. Сезнең тәрҗемә итәсегез килсә, зинһар, [https://translatewiki.net/wiki/Main_Page?setlang=tt-cyrl translatewiki.net] кулланыгыз.",
...
'extlink_sample'  => 'https://www.example.com сылтаманың башламы',
'extlink_tip'     => 'Тышкы сылтама (https:// алкушымчасы турында онытмагыз)',
