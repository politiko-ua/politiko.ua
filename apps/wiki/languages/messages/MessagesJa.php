...
'mainpagedocfooter' => '使い方・設定に関しては[https://meta.wikimedia.org/wiki/%E3%83%98%E3%83%AB%E3%83%97:%E7%9B%AE%E6%AC%A1 ユーザーズガイド]を参照してください。

== はじめましょう ==

* [https://www.mediawiki.org/wiki/Manual:Configuration_settings/ja 設定リスト]
* [https://www.mediawiki.org/wiki/Manual:FAQ/ja MediaWiki FAQ]
...
'editinginterface'     => "'''警告:''' あなたはソフトウェアのインターフェースに使用されているテキストを編集しています。このページの変更はすべての利用者のユーザインタフェースに影響します。翻訳をする場合、MediaWiki の多言語対応プロジェクトである [https://translatewiki.net/wiki/Main_Page?setlang=ja translatewiki.net] の利用を検討してください。",
'sqlhidden'            => '(SQLクエリ非表示)',
...
'link_sample'     => 'ページ名',
'link_tip'        => '内部リンク',
'extlink_sample'  => 'https://www.example.com リンクのタイトル',
'extlink_tip'     => '外部リンク（https:// を忘れずにつけてください）',
'headline_sample' => '見出し',
...
'upload-proto-error-text' => 'アップロード元のURLは <code>https://</code> か <code>ftp://</code> で始まっている必要があります。',
...
'statistics-jobqueue'          => '[https://www.mediawiki.org/wiki/Manual:Job_queue ジョブ・キュー]の長さ',
...
'allmessagestext'           => 'これは MediaWiki 名前空間で利用可能なシステムメッセージの一覧です。MediaWiki の一般的なローカリゼーションに貢献したい場合は、[https://www.mediawiki.org/wiki/Localisation MediaWiki Localisation] や [https://translatewiki.net?setlang=ja translatewiki.net] を訪れてみてください。',
...
'edit-externally-help' => '(詳しい情報は[https://www.mediawiki.org/wiki/Manual:External_editors 外部エディタに関する説明（英語）]をご覧ください。)',
