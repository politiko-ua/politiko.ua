...
$bookstoreList = array(
	'Bookplus'                      => 'https://www.bookplus.fi/product.php?isbn=$1',
	'Helsingin yliopiston kirjasto' => 'https://pandora.lib.hel.fi/cgi-bin/mhask/monihask.py?volname=&author=&keyword=&ident=$1&submit=Hae&engine_helka=ON',
	'Pääkaupunkiseudun kirjastot'   => 'https://www.helmet.fi/search*fin/i?SEARCH=$1',
	'Tampereen seudun kirjastot'    => 'https://kirjasto.tampere.fi/Piki?formid=fullt&typ0=6&dat0=$1'
);
...
'mainpagedocfooter' => "Lisätietoja käytöstä on sivulla [https://meta.wikimedia.org/wiki/Help:Contents User's Guide].

=== Lisäohjeita ===

* [https://www.mediawiki.org/wiki/Manual:Configuration_settings Asetusten teko-ohjeita]
* [https://www.mediawiki.org/wiki/Manual:FAQ MediaWikin FAQ]
...
Viestien kääntäminen tulisi tehdä [https://translatewiki.net/wiki/Main_Page?setlang=fi translatewiki.netissä] – MediaWikin kotoistusprojektissa.",
...
'extlink_sample'  => 'https://www.example.com linkin otsikko',
'extlink_tip'     => 'Ulkoinen linkki (muista https:// edessä)',
...
'upload-proto-error-text' => 'Etälähetys on mahdollista vain osoitteista, jotka alkavat merkkijonolla <code>https://</code> tai <code>ftp://</code>.',
...
'statistics-jobqueue'          => 'Ohjelmiston suorittamia [https://www.mediawiki.org/wiki/Manual:Job_queue ylläpitotöitä jonossa]',
...
'blockiptext'                     => 'Tällä lomakkeella voit estää käyttäjän tai IP-osoitteen muokkausoikeudet. Muokkausoikeuksien poistamiseen pitää olla syy, esimerkiksi sivujen vandalisointi. Kirjoita syy siihen varattuun kenttään.<br />Vapaamuotoisen vanhenemisajat noudattavat GNUn standardimuotoa, joka on kuvattu tar-manuaalissa ([https://www.gnu.org/software/tar/manual/html_node/Date-input-formats.html] [EN]), esimerkiksi ”1 hour”, ”2 days”, ”next Wednesday”, 2005-08-29”.',
'ipaddress'                       => 'IP-osoite',
...
Jos haluat muokata MediaWikin yleistä kotoistusta, käy [https://www.mediawiki.org/wiki/Localisation MediaWikin kotoistussivuilla] ja sivustolla [https://translatewiki.net translatewiki.net].',
