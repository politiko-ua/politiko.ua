...
$bookstoreList = array(
	...
	'博客來書店' => 'https://www.books.com.tw/exep/prod/booksfile.php?item=$1',
	'三民書店' => 'https://www.sanmin.com.tw/page-qsearch.asp?ct=search_isbn&qu=$1',
	'天下書店' => 'https://www.cwbook.com.tw/search/result1.jsp?field=2&keyWord=$1',
	'新絲路書店' => 'https://www.silkbook.com/function/Search_list_book_data.asp?item=5&text=$1'
);
...
==開始使用==
* [https://www.mediawiki.org/wiki/Manual:Configuration_settings 配置設定清單]（英）
* [https://www.mediawiki.org/wiki/Manual:FAQ MediaWiki 常見問題]（英）
...
'editinginterface'     => "'''警告：'''你而家編輯緊嘅呢一個用嚟提供介面文字嘅頁面。響呢一頁嘅更改會影響到其他用戶使用中嘅介面外觀。要翻譯，請考慮利用[https://translatewiki.net/wiki/Main_Page?setlang=yue translatewiki.net]，一個用來為MediaWiki軟件本地化嘅計劃。",
'sqlhidden'            => '(SQL 查詢隱藏)',
...
'link_sample'     => '連結標題',
'link_tip'        => '內部連結',
'extlink_sample'  => 'https://www.example.com 連結標題',
'extlink_tip'     => '連出去（記住加 https:// 開頭）',
...
'upload-proto-error-text' => '遙遠上載需要一個以 <code>https://</code> 或者 <code>ftp://</code> 作為開頭嘅URL。',
...
'statistics-jobqueue'          => '[https://www.mediawiki.org/wiki/Manual:Job_queue 工作隊列]長度',
...
如果想貢獻正宗嘅MediaWiki本地化嘅話，請參閱[https://www.mediawiki.org/wiki/Localisation MediaWiki本地化]同埋[https://translatewiki.net translatewiki.net]。',
