...
'mainpagedocfooter' => 'Аз [https://meta.wikimedia.org/wiki/Help:Contents Роҳнамои Корбарон] барои истифодаи нармафзори вики кӯмак бигиред.

== Оғоз ба кор ==

* [https://www.mediawiki.org/wiki/Manual:Configuration_settings Феҳристи танзимоти пайгирбандӣ]
* [https://www.mediawiki.org/wiki/Manual:FAQ Пурсишҳои МедиаВики]
...
'editinginterface'     => "'''Огоҳӣ:''' Шумо саҳифаеро вироиш карда истодаед, ки матни интерфейси барнома мебошад. Тағйироти ин саҳифа барои намуди интерфейси дигар корбарон таъсир хоҳад расонид. Барои тарҷумаҳо, лутфан аз [https://translatewiki.net/wiki/Main_Page?setlang=tg Бетавики], ки лоиҳаи маҳаликунонии МедиаВики мебошад, истифода кунед.",
...
'extlink_sample'  => 'https://www.example.com унвони пайванд',
'extlink_tip'     => 'Пайванди беруна (пешванди https:// фаромӯш накунед)',
...
'upload-proto-error-text' => 'Боргузори аз дурдаст бо нишонаҳое, ки бо <code>https://</code> ё <code>ftp://</code> оғоз мешаванд, ниёз дорад.',
