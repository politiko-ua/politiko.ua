...
* [https://www.mediawiki.org/wiki/Manual:Configuration_settings మీడియావికీ పనితీరు, అమరిక మార్చుకునేందుకు వీలుకల్పించే చిహ్నాల జాబితా]
* [https://www.mediawiki.org/wiki/Manual:FAQ మీడియావికీపై తరుచుగా అడిగే ప్రశ్నలు]
...
అనువాదాల కొరకైతే, [https://translatewiki.net/wiki/Main_Page?setlang=te ట్రాన్స్‌లేట్ వికీ.నెట్], మీడియావికీ స్థానికీకరణ ప్రాజెక్టు, ని వాడండి.",
...
'extlink_sample'  => 'https://www.example.com లింకు పేరు',
'extlink_tip'     => 'బయటి లింకు (దీనికి ముందు https:// ఇవ్వటం మరువకండి)',
...
'upload-proto-error-text' => 'రిమోట్ అప్‌లోడులు చెయ్యాలంటే URLలు <code>https://</code> లేదా <code>ftp://</code> తో మొదలు కావాలి.',
...
'statistics-jobqueue'          => '[https://www.mediawiki.org/wiki/Manual:Job_queue పనుల వరుస] పొడవు',
...
మీరు అన్ని వికీపీడియాలకూ కలిపి ఒకేసారి అనువదించాలని అనుకుంటే, దయచేసి [https://www.mediawiki.org/wiki/Localisation మీడియావికీ అనువాదం] మరియూ [https://translatewiki.net బేటావికీ] సైట్లను చూడండి.',
