...
* [https://www.mediawiki.org/wiki/Manual:Configuration_settings تنظیم پیکربندی]
* [https://www.mediawiki.org/wiki/Manual:FAQ MediaWiki پرسش‌های متداول]
...
'extlink_sample'  => 'https://www.example.com عنوان پیوند',
'extlink_tip'     => 'پیوند به بیرون (پیشوند https:// را فراموش نکنید)',
...
'upload-proto-error-text' => 'بارگذاری از دوردست به نشانی‌هایی که با <code dir=ltr>https://</code> یا <code dir=ltr>ftp://</code> آغاز شوند نیاز دارد.',
...
'statistics-jobqueue'          => 'طول [https://www.mediawiki.org/wiki/Manual:Job_queue صف کار]',
