...
* [https://www.mediawiki.org/wiki/Manual:Configuration_settings Конфигурация уларытыытын параметрдара]
...
'extlink_sample'  => 'https://www.example.com ыйынньык баһа',
'extlink_tip'     => 'Тас ыйынньык (https:// префиксы умнума)',
...
'upload-proto-error-text' => 'Ыраахтан суруттарарга маннык аадырыстар наадалар: <code>https://</code> эбэтэр <code>ftp://</code>.',
...
'statistics-jobqueue'          => '[https://www.mediawiki.org/wiki/Manual:Job_queue Job queue] кээмэйэ',
...
Эн MediaWiki движогун тылбаастыырга көмөлөһүөххүн баҕарар буоллаххына манна [https://www.mediawiki.org/wiki/Localisation MediaWiki Localisation] уонна манна [https://translatewiki.net translatewiki.net] киир.',
