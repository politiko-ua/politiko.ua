...
'editinginterface'     => "'''Caveat censor:''' Emendas iam paginam quae textum interfaciei logicialem dat. Mutationes vultum {{grammar:genitive|{{SITENAME}}}} omnibus usoribus afficient. In nuntia MediaWiki vertendo, quaesumus te uti [https://translatewiki.net/wiki/Main_Page?setlang=la translatewiki.net].",
...
'extlink_sample'  => 'https://www.example.com titulus nexus externi',
'extlink_tip'     => 'Nexus externus (memento praefixi https://)',
...
'searchdisabled'           => 'Per {{grammar:accusative|{{SITENAME}}}} ad tempus non potes quaerere. Interea per [https://www.google.com Googlem] quaeras. Nota indices {{grammar:genitive|{{SITENAME}}}} contentorum apud Googlem fortasse antiquiores esse.',
...
'statistics-jobqueue'          => 'Numerus [https://www.mediawiki.org/wiki/Manual:Job_queue operationum qui etiam exspectant perfacier]',
