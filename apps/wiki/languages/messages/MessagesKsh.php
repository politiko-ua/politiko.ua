...
'mainpagedocfooter' => 'Luur en et (änglesche) [https://meta.wikimedia.org/wiki/Help:Contents Handboch] wann De wesse wells wie de Wiki-Soffwär jebruch un bedeent wääde muss.
...
'extlink_sample'  => 'https://www.example.com/dat_he_oohne_Zwescheräum Donoh dä Anker Tex',
'extlink_tip'     => 'Ene Link noh drusse (denk dran, https:// aan dr Aanfang!)',
...
'right-noratelimit'          => 'Kein Beschränkunge dorch Jrenze (<i lang="en">[https://www.mediawiki.org/wiki/Manual:%24wgRateLimits $wgRateLimits]</i>)',
...
'upload-proto-error-text' => 'Ene URL för en Datei fun huhzelade moß met <code>https://</code> uder <code>ftp://</code> aafange.',
...
'statistics-jobqueue'          => 'Endrääch en de [https://www.mediawiki.org/wiki/Manual:Job_queue Leß met de Aufjabe]',
...
Beim Söke künnd_Er Shternshe aanjevve för e Shtöckshe fun ennem Name, wo mer nit jenou weiß, wi et heiß udder wat me nit kenne deit, zem Beishpöll esu: <tt>https://*.example.com</tt>
...
Wenn De jenerell aan [https://www.mediawiki.org/wiki/Localisation MediaWiki singe Översezung] jet anders han wells, do jangk noh [https://translatewiki.net translatewiki.net].',
...
'edit-externally-help' => '(Luur en de [https://www.mediawiki.org/wiki/Manual:External_editors Installationsaanweisunge] noh mieh Hinwies)',
