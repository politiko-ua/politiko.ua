...
$specialPageAliases = array(
	...
	'MIMEsearch'                => array( 'MIME 搜索' ),
	'Unusedtemplates'           => array( '未使用的模板' ),
	'Mypage'                    => array( '我的页面' ),
	'Mytalk'                    => array( '我的对话页' ),
	...
	'Filepath'                  => array( '文件路径' ),
	'Invalidateemail'           => array( '不可识别的电子邮件地址' ),
	'Blankpage'                 => array( '空白页' ),
...
$bookstoreList = array(
	...
	'博客来书店' => 'https://www.books.com.tw/exep/prod/booksfile.php?item=$1',
	'三民书店' => 'https://www.sanmin.com.tw/page-qsearch.asp?ct=search_isbn&qu=$1',
	'天下书店' => 'https://www.cwbook.com.tw/search/result1.jsp?field=2&keyWord=$1',
	'新丝路书店' => 'https://www.silkbook.com/function/Search_list_book_data.asp?item=5&text=$1'
);
...
'mainpagedocfooter' => '请访问 [https://meta.wikimedia.org/wiki/Help:Contents 用户手册] 以获得使用此 wiki 软件的信息！

== 入门 ==

* [https://www.mediawiki.org/wiki/Manual:Configuration_settings MediaWiki 配置设置列表]
* [https://www.mediawiki.org/wiki/Manual:FAQ MediaWiki 常见问题解答]
...
'editinginterface'     => "'''警告:''' 您正在编辑的页面是用于提供软件的界面文本。改变此页将影响其他用户的界面外观。如要翻译，请考虑使用[https://translatewiki.net/wiki/Main_Page?setlang=zh-hans translatewiki.net]，一个用来为MediaWiki软件本地化的计划。",
'sqlhidden'            => '(SQL查询已隐藏)',
...
'link_sample'     => '链接标题',
'link_tip'        => '内部链接',
'extlink_sample'  => 'https://www.example.com 链接标题',
'extlink_tip'     => '外部链接(加前缀 https://)',
...
'upload-proto-error-text' => '远程上传要求 URL 以 <code>https://</code> 或 <code>ftp://</code> 开头。',
...
'statistics-jobqueue'          => '[https://www.mediawiki.org/wiki/Manual:Job_queue 工作队列]长度',
...
如果想贡献正宗的MediaWiki本地化的话，请参阅[https://www.mediawiki.org/wiki/Localisation MediaWiki本地化]以及[https://translatewiki.net translatewiki.net]。',
