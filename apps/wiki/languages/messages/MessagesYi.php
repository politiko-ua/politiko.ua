...
* [https://www.mediawiki.org/wiki/Manual:Configuration_settings רשימה פון קאנפֿיגוראציעס]
* [https://www.mediawiki.org/wiki/Manual:FAQ אפֿט געפֿרעגטע שאלות]
...
'extlink_sample'  => 'https://www.example.com לינק טיטל',
'extlink_tip'     => 'דערויסענדיגע לינק (געדענק https:// פרעפיקס)',
...
'statistics-jobqueue'          => 'לענג [https://www.mediawiki.org/wiki/Manual:Job_queue אויפֿגאַבעס ריי]',
...
ביטע באזוכט [https://www.mediawiki.org/wiki/Localisation מעדיעוויקי לאקאליזאציע] און [https://translatewiki.net בעטאוויקי] אויב איר ווילט ביישטייערן צו דער גענערישער מעדיעוויקי לאקאליזאציע.',
