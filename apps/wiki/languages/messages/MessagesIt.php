...
'mainpagedocfooter' => "Consultare la [https://meta.wikimedia.org/wiki/Aiuto:Sommario Guida utente] per maggiori informazioni sull'uso di questo software wiki.

== Per iniziare ==
I seguenti collegamenti sono in lingua inglese:

* [https://www.mediawiki.org/wiki/Manual:Configuration_settings Impostazioni di configurazione]
...
Per le traduzioni, considera la possibilità di usare [https://translatewiki.net/wiki/Main_Page?setlang=it translatewiki.net], il progetto MediaWiki per la localizzazione.",
...
'extlink_sample'  => 'https://www.example.com titolo del collegamento',
'extlink_tip'     => 'Collegamento esterno (ricorda il prefisso https:// )',
...
'upload-proto-error-text' => "Per l'upload remoto è necessario specificare URL che iniziano con <code>https://</code> oppure <code>ftp://</code>.",
...
'statistics-jobqueue'          => '[https://www.mediawiki.org/wiki/Manual:Job_queue Coda dei processi] da eseguire in background',
...
Visitare [https://www.mediawiki.org/wiki/Localisation MediaWiki Localisation] e [https://translatewiki.net translatewiki.net] se si desidera contribuire alla localizzazione generica di MediaWiki.',
