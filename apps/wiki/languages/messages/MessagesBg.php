...
$bookstoreList = array(
	'books.bg'   => 'https://www.books.bg/ISBN/$1',
	'Пингвините' => 'https://www.pe-bg.com/?cid=3&search_q=$1&where=ISBN&x=0&y=0**',
	'Бард'       => 'https://www.bard.bg/search/?q=$1'
);
...
'mainpagedocfooter' => 'Разгледайте [https://meta.wikimedia.org/wiki/Help:Contents ръководството] за подробна информация относно използването на софтуера.

== Първи стъпки ==

* [https://www.mediawiki.org/wiki/Manual:Configuration_settings Конфигурационни настройки]
* [https://www.mediawiki.org/wiki/Manual:FAQ ЧЗВ за МедияУики]
...
За превеждане обмислете използването на [https://translatewiki.net/wiki/Main_Page?setlang=bg translatewiki.net], проектът за локализиране на MediaWiki.",
...
'extlink_sample'  => 'https://www.example.com Текст на външната препратка',
'extlink_tip'     => 'Външна препратка (не забравяйте https:// отпред)',
...
'upload-proto-error-text' => 'Изисква се адрес започващ с <code>https://</code> или <code>ftp://</code>.',
...
'statistics-jobqueue'          => 'Дължина на [https://www.mediawiki.org/wiki/Manual:Job_queue работната опашка]',
...
Посетете [https://www.mediawiki.org/wiki/Localisation MediaWiki Localisation] и [https://translatewiki.net translatewiki.net], ако желаете да допринесете за общата локализация на софтуера МедияУики.',
