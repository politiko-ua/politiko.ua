...
'mainpagedocfooter' => 'Zobacz [https://meta.wikimedia.org/wiki/Help:Contents przewodnik użytkownika] w celu uzyskania informacji o działaniu oprogramowania wiki.

== Na początek ==
* [https://www.mediawiki.org/wiki/Manual:Configuration_settings Lista ustawień konfiguracyjnych]
...
Rozważ wykonanie tłumaczenia na [https://translatewiki.net/wiki/Main_Page?setlang=pl translatewiki.net], specjalizowanym projekcie lokalizacji oprogramowania MediaWiki.",
...
'extlink_sample'  => 'https://www.example.com nazwa linku',
'extlink_tip'     => 'Link zewnętrzny (pamiętaj o przedrostku https:// )',
...
'upload-proto-error-text' => 'Zdalne przesyłanie plików wymaga podania adresu URL zaczynającego się od <code>https://</code> lub <code>ftp://</code>.',
...
'statistics-jobqueue'          => 'Rozmiar [https://www.mediawiki.org/wiki/Manual:Job_queue kolejki zadań]',
...
Odwiedź [https://www.mediawiki.org/wiki/Localisation Tłumaczenie MediaWiki] oraz [https://translatewiki.net translatewiki.net], jeśli chcesz uczestniczyć w tłumaczeniu oprogramowania MediaWiki.',
