...
$bookstoreList = array(
	'Aladdin.co.kr' => 'https://www.aladdin.co.kr/catalog/book.asp?ISBN=$1',
	'inherit' => true,
);
...
'mainpagedocfooter' => '[https://meta.wikimedia.org/wiki/Help:Contents 이곳]에서 위키 프로그램에 대한 정보를 얻을 수 있습니다.

== 시작하기 ==

* [https://www.mediawiki.org/wiki/Manual:Configuration_settings 설정하기]
* [https://www.mediawiki.org/wiki/Manual:FAQ 미디어위키 FAQ]
...
'editinginterface'     => "'''경고''': 소프트웨어에서 사용하는 메시지 문서를 고치고 있습니다. 이것은 모든 사용자에게 영향을 끼칩니다. 번역되지 않은 메시지를 번역하려는 경우에는, [https://translatewiki.net/wiki/Main_Page?setlang=ko 베타위키(translatewiki.net)]에 참여하면 메시지 번역을 미디어위키에 직접 반영할 수 있습니다.",
...
'link_sample'     => '링크 제목',
'link_tip'        => '내부 링크',
'extlink_sample'  => 'https://www.example.com 사이트 이름',
'extlink_tip'     => '외부 사이트 링크 (앞에 https://를 붙여야 합니다.)',
'headline_sample' => '제목',
...
'upload-proto-error-text' => '파일을 URL로 올리려면 <code>https://</code>이나 <code>ftp://</code>로 시작해야 합니다.',
...
'statistics-jobqueue'          => '[https://www.mediawiki.org/wiki/Manual:Job_queue Job queue]의 길이',
...
'allmessagestext'           => '미디어위키 이름공간에 있는 모든 시스템 메시지의 목록입니다. 미디어위키의 번역 작업에 관심이 있으시다면 [https://www.mediawiki.org/wiki/Localisation 미디어위키 지역화]나 [https://translatewiki.net 베타위키]에 참가해주세요.',
...
'edit-externally-help' => '(자세한 정보는 [https://www.mediawiki.org/wiki/Manual:External_editors 설치 방법]을 참고하십시오)',
