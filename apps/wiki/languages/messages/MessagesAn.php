...
'mainpagedocfooter' => "Consulta a [https://meta.wikimedia.org/wiki/Help:Contents Guía d'usuario] ta mirar informazión sobre cómo usar o software wiki.

== Ta prenzipiar ==

* [https://www.mediawiki.org/wiki/Manual:Configuration_settings Lista de carauteristicas confegurables]
* [https://www.mediawiki.org/wiki/Manual:FAQ Preguntas cutianas sobre MediaWiki (FAQ)]
...
'editinginterface'     => "'''Pare cuenta:''' Ye editando una pachina emplegata ta furnir o testo d'a interfaz de {{SITENAME}}. Os cambeos en ista pachina tendrán efeuto en l'aparenzia d'a interfaz ta os atros usuarios. Ta fer traduzions d'a interfaz, puede considerar fer serbir [https://translatewiki.net/wiki/Main_Page?setlang=an translatewiki.net], o procheuto de localizazión de MediaWiki.",
...
'extlink_sample'  => "https://www.example.com Títol d'o binclo",
'extlink_tip'     => "Binclo esterno (alcuerde-se d'adibir o prefixo https://)",
...
'upload-proto-error-text' => 'Si quiere cargar archibos dende atra pachina, a URL ha de prenzipiar por <code>https://</code> u <code>ftp://</code>.',
...
'statistics-jobqueue'          => "Longaria d'a [https://www.mediawiki.org/wiki/Manual:Job_queue coda de treballos]",
...
Besite por fabor [https://www.mediawiki.org/wiki/Localisation a pachina sobre localizazión de MediaWiki] y  [https://translatewiki.net translatewiki.net] si deseya contrebuyir t'a localizazión cheneral de MediaWiki.",
...
'edit-externally-help' => '(Leiga as [https://www.mediawiki.org/wiki/Manual:External_editors instruzions de confegurazión] ta más informazión)',
