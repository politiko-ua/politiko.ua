...
* [https://www.mediawiki.org/wiki/Manual:Configuration_settings Пералік параметраў канфігурацыі (англ.)]
* [https://www.mediawiki.org/wiki/Manual:FAQ ЧАПЫ MediaWiki (англ.)]
...
'extlink_sample'  => 'https://www.example.com назва спасылкі',
'extlink_tip'     => 'Вонкавая спасылка (памятайце аб прэфіксе https://)',
...
'upload-proto-error-text' => 'Укладанне файла зводдаль патрабуе URL, які пачынаецца з <code>https://</code> або <code>ftp://</code>.',
...
'statistics-jobqueue'          => 'Даўжыня [https://www.mediawiki.org/wiki/Manual:Job_queue чаргі задач]',
