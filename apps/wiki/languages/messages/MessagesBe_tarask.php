...
$bookstoreList = array(
	'OZ.by' => 'https://oz.by/search.phtml?what=books&isbn=$1',
...
== З чаго пачаць ==
* [https://www.mediawiki.org/wiki/Manual:Configuration_settings Сьпіс парамэтраў канфігурацыі]
* [https://www.mediawiki.org/wiki/Manual:FAQ Частыя пытаньні MediaWiki]
...
Калі ласка, выкарыстоўвайце [https://translatewiki.net/wiki/Main_Page?setlang=be-tarask translatewiki.net] — праект для лякалізацыі MediaWiki.",
...
'extlink_sample'  => 'https://www.example.com загаловак спасылкі',
'extlink_tip'     => 'Вонкавая спасылка (не забывайцеся пачынаць з https:// )',
...
'upload-proto-error-text' => 'Аддаленая загрузка файлаў патрабуе URL-адрас, які пачынаецца з <code>https://</code> альбо <code>ftp://</code>.',
...
'statistics-jobqueue'          => 'Даўжыня [https://www.mediawiki.org/wiki/Manual:Job_queue чаргі заданьняў]',
...
Калі ласка, наведайце [https://www.mediawiki.org/wiki/Localisation старонку пра лякалізацыю MediaWiki] і [https://translatewiki.net translatewiki.net], калі Вы жадаеце ўдзельнічаць у перакладзе MediaWiki.',
