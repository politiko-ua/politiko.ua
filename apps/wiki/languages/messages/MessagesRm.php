...
'editinginterface' => "'''Attenziun:''' Questa pagina cuntegn text che vegn duvra da software da mediawiki. Midadas influenzeschan directamain l'interface da l'utilisader. Sche ti vuls far translaziuns u correcturas: Studegia da far quai sin [https://translatewiki.net/wiki/Main_Page?setlang=rm translatewiki.net], per che las midadas pon vegnidas surprendidas da tut ils projects.",
...
'extlink_tip'     => 'Link extern (risguardar il prefix https:// )',
...
Fai ina visita sin [https://www.mediawiki.org/wiki/Localisation MediaWiki Localisation] e [https://translatewiki.net translatewiki.net] sche ti vuls gidar da translatar la software da MediaWiki.',
