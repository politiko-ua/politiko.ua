...
تغییرات ای صفحه کاربرد مداخله گر په دگه کابران تاثیر هلیت.
  [https://translatewiki.net/wiki/Main_Page?setlang=en translatewiki.net],  په ترجمه یان لطفا توجه کنیت په استفاده پروژه ملکی کتن مدیا وی کی",
...
'link_tip'        => 'لینک درونی',
'extlink_sample'  => 'https://www.example.com عنوان لینک',
'extlink_tip'     => 'حارجی لینک(مشموش  https:// پیشوند)',
...
'upload-proto-error-text' => 'آپلود دراین نیاز په URL آنی داریت که شروع بیت گون  <code>https://</code> یا <code>ftp://</code>.',
...
'statistics-jobqueue'          => '[https://www.mediawiki.org/wiki/Manual:Job_queue طول کار] ای',
...
لطفا بچاریت  [https://www.mediawiki.org/wiki/Localisation MediaWiki Localisation] و [https://translatewiki.net translatewiki.net] اگر شما لوٹیت ته ملکی کتن مدیا وی کی کمک کنیت.',
