...
'mainpagedocfooter' => "Che a varda la [https://meta.wikimedia.org/wiki/MediaWiki_User%27s_Guide User's Guide] (belavans për adess a-i é mach n'anglèis) për avej dj'anformassion suplementar ant sël coma dovré ël programa dla wiki.
...
'extlink_sample'  => "https://www.example.com tìtol dl'anliura",
'extlink_tip'     => 'Anliura esterna (che as visa dë buté ël prefiss https://)',
...
'upload-proto-error-text' => "Për carié da dij servent lontan a venta buté dj'anliure ch'as anandio për <code>https://</code> ò pura <code>ftp://</code>.",
...
'edit-externally-help' => "Che a varda [https://www.mediawiki.org/wiki/Manual:External_editors setup instructions] për avej pì d'anformassion.",
