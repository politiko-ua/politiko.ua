...
'extlink_sample'  => 'https://www.example.com հղման վերնագիրը',
'extlink_tip'     => 'Արտաքին հղում (հիշեք https:// նախածանցը)',
...
'upload-proto-error-text' => 'Հեռավոր բեռնումը պահանջում է URL-հասցե, որը սկսվում է <code>https://</code> կամ <code>ftp://</code> նախածանցով։',
...
'edit-externally-help' => 'Մանրամասնությունների համար տես [https://www.mediawiki.org/wiki/Manual:External_editors Meta:Help:External_editors]։',
