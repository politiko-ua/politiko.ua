...
'editinginterface'     => "'''警告:''' 您正在編輯的頁面是用於提供軟體的介面文字。改變此頁將影響其他用戶的介面外觀。如要翻譯，請考慮使用[https://translatewiki.net/wiki/Main_Page?setlang=zh-hant translatewiki.net]，一個用來為MediaWiki軟件本地化的計劃。",
'sqlhidden'            => '(隱藏SQL查詢)',
...
'upload-proto-error-text' => '遠程上傳要求 URL 以 <code>https://</code> 或 <code>ftp://</code> 開頭。',
...
如果想貢獻正宗的MediaWiki本地化的話，請參閱[https://www.mediawiki.org/wiki/Localisation MediaWiki本地化]以及[https://translatewiki.net translatewiki.net]。',
