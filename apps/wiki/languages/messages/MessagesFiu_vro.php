...
* [https://www.mediawiki.org/wiki/Manual:Configuration_settings Säädmiisi oppus (inglüse keelen)]
* [https://www.mediawiki.org/wiki/Manual:FAQ MediaWiki kõgõ küsütümbäq küsümiseq (inglüse keelen)]
...
'editinginterface'     => "'''Hoiatus:''' Sa toimõndat tarkvara pruukjapalgõ tekstiga lehte. Ku siin midä muudat, mõotas tuu pruukjapalõt. Ümbrepandmisõs tasos pruukiq MediaWiki ümbrepandmisõ tüüriista [https://translatewiki.net/wiki/Main_Page?setlang=fiu-vro Betawiki].",
...
'extlink_tip'     => 'Välislink (unõhtagu-i ette pandaq https://)',
...
'upload-proto-error-text' => 'Üles saa laatiq õnnõ aadrõssidõ päält, mink alostusõn om <code>https://</code> vai <code>ftp://</code>.',
...
Please visit [https://www.mediawiki.org/wiki/Localisation MediaWiki Localisation] and [https://translatewiki.net Betawiki] if you wish to contribute to the generic MediaWiki localisation.',
