...
== Бастау үшін ==
* [https://www.mediawiki.org/wiki/Manual:Configuration_settings Бапталым қалауларының тізімі]
* [https://www.mediawiki.org/wiki/Manual:FAQ МедиаУикидің Жиы Қойылған Сауалдары]
...
Аудармалар үшін, MediaWiki бағдарламасын жерсіндіру [https://translatewiki.net/wiki/Main_Page?setlang=kk translatewiki.net жобасы] арқылы қарап шешіңіз.",
...
'extlink_sample'  => 'https://www.example.com сілтеме тақырыбын аты',
'extlink_tip'     => 'Шеттік сілтеме (алдынан https:// енгізуін ұмытпаңыз)',
...
'upload-proto-error-text' => 'Шеттен қотарып беру үшін URL жайлары <code>https://</code> немесе <code>ftp://</code> дегендерден басталу жөн.',
...
Егер әмбебап MediaWiki жерсіндіруге үлес қосқыңыз келсе [https://www.mediawiki.org/wiki/Localisation MediaWiki жерсіндіру бетіне] және [https://translatewiki.net translatewiki.net жобасына] барып шығыңыз.',
...
'edit-externally-help' => 'Көбірек ақпарат үшін [https://www.mediawiki.org/wiki/Manual:External_editors орнату нұсқамаларын] қараңыз.',
