...
$bookstoreList = array(
	...
	'Books.Ru' => 'https://www.books.ru/shop/search/advanced?as%5Btype%5D=books&as%5Bname%5D=&as%5Bisbn%5D=$1&as%5Bauthor%5D=&as%5Bmaker%5D=&as%5Bcontents%5D=&as%5Binfo%5D=&as%5Bdate_after%5D=&as%5Bdate_before%5D=&as%5Bprice_less%5D=&as%5Bprice_more%5D=&as%5Bstrict%5D=%E4%E0&as%5Bsub%5D=%E8%F1%EA%E0%F2%FC&x=22&y=8',
...
'mainpagedocfooter' => 'Информацию по работе с этой вики можно найти в [https://meta.wikimedia.org/wiki/%D0%9F%D0%BE%D0%BC%D0%BE%D1%89%D1%8C:%D0%A1%D0%BE%D0%B4%D0%B5%D1%80%D0%B6%D0%B0%D0%BD%D0%B8%D0%B5 руководстве пользователя].

== Некоторые полезные ресурсы ==
* [https://www.mediawiki.org/wiki/Manual:Configuration_settings Список возможных настроек];
* [https://www.mediawiki.org/wiki/Manual:FAQ Часто задаваемые вопросы и ответы по MediaWiki];
...
Для переводов лучше использовать [https://translatewiki.net/wiki/Main_Page?setlang=ru translatewiki.net], проект по локализации MediaWiki.",
...
'extlink_sample'  => 'https://www.example.com заголовок ссылки',
'extlink_tip'     => 'Внешняя ссылка (помните о префиксе https:// )',
...
'upload-proto-error-text' => 'Для удалённой загрузки требуется адрес, начинающийся с <code>https://</code> или <code>ftp://</code>.',
...
'statistics-jobqueue'          => 'Величина [https://www.mediawiki.org/wiki/Manual:Job_queue очереди заданий]',
...
Пожалуйста, посетите на страницу [https://www.mediawiki.org/wiki/Localisation описания локализации] и проект [https://translatewiki.net translatewiki.net], если вы хотите внести вклад в общую локализацию MediaWiki.',
